<!--- <cfinclude template="output.cfm">
<cfabort> --->
<!--- <cfdump var="#form#">
<cfdump var="#URL#">
<cfset bSuccess = StructAppend( form, URL )> --->
<!--- <cfabort> --->
<!--- <CFSET form.sVendTIN = session.TheVendTin> --->
<!--- <cfdump var="#session.TheVendTin#"><cfabort> --->
...
<CFIF IsDefined ("URL.VendTINName") and IsDefined("URL.SVendTIN")>
...
<cfif UpOrDown.strValue eq "OFFLINE">
 <P>The information warehouse went offline a short time ago. Please try your inquiry again in a few minutes. </P>
 <cfoutput>
...
<CFELSE>
    ...
    <CFQUERY NAME="VendVerify" DATASOURCE="#application.WHDSN#" cachedwithin="#CreateTimeSpan(0,0,30,0)#">
    SELECT Vendor_TIN
    FROM wh.VENDOR
    ...
    <CFQUERY NAME="ContSumm" DATASOURCE="#application.WHDSN#" cachedwithin="#CreateTimeSpan(0,0,0,1)#">
        SELECT
    ...
    <CFQUERY NAME="ContCount" DATASOURCE="#application.WHDSN#" <!--- cachedwithin="#CreateTimeSpan(0,0,30,0)#"---> cachedwithin="#CreateTimeSpan(0,0,0,1)#">
    ...
    <CFQUERY NAME="ExpSumm" DATASOURCE="#application.WHDSN#" <!---cachedwithin="#CreateTimeSpan(0,0,30,0)#"---> cachedwithin="#CreateTimeSpan(0,0,0,1)#">
        SELECT
    ...
    <CFQUERY NAME="PaymentCount" DATASOURCE="#application.WHDSN#" <!---cachedwithin="#CreateTimeSpan(0,0,30,0)#"---> cachedwithin="#CreateTimeSpan(0,0,0,1)#">
...
<!---<div class="col-sm-12"><h2><center>Vendor Summary</center></h2></div>--->

    <cfif GetVendor.SAMS_Delete_Date is not "">
        <p class="text-center bold">Vendor Status: No longer on file.  No activity in the past two years.</p>
    <cfelseif trim(GetVendor.Cert_Ind) is "C">
        <p class="text-center bold">Vendor Status: Certified</p>
    <cfelseif trim(GetVendor.Cert_Ind) is "N" or trim(GetVendor.Cert_Ind) is "T">
        <p class="text-danger" align="center"><b>Vendor Status: On file, but not certified</b></p>
    </cfif>
       ...
       <cfif trim(ErrorNo) is "">
            ...
            <cfif CheckVendorRemitEmailRetVal is 0>
                ...
                <cfif UpdtVendorUserInfoRetVal is 0>
                    <cflocation url="/vendors/vendor-payments-new/vendor-summary/?Mode=Login&NotificationType=#URLEncodedFormat(form.NotificationType)#&VENDTINNAME=#URLEncodedFormat(form.VendTINName)#&RecSaved=Yes&SVendTIN=#urlEncodedFormat(form.SVendTIN)#" addtoken="No">
                </cfif>
            <cfelse>
...
<CFELSE>
    ...
    <CFOUTPUT QUERY="ContCount">
     ...
     <div class="form-group">
     	<div class="col-sm-offset-3 col-sm-4 col-md-offset-4 col-md-3">
            <label for="ContContNum" id="ContContNumlbl">Number of Contracts</label>
        </div>
        <div class="col-sm-3 col-md-2">#NumberFormat(ContCountNum)#</div>
    </div>
    </CFOUTPUT>
    <CFOUTPUT QUERY="ContSumm">
     <div class="form-group">
        ...
        <div class="col-sm-3 col-md-2">#DollarFormat(ContTotal)#
        </div>
    </div>
    <div class="form-group">
        <div class="col-sm-offset-3 col-sm-4 col-md-offset-4 col-md-3">
        ...
        <div class="col-sm-3 col-md-2">#DollarFormat(ContEncTotal)#
        </div>
    </div>
    <div class="form-group">
        <div class="col-sm-offset-3 col-sm-4 col-md-offset-4 col-md-3">
        ...
        <div class="col-sm-3 col-md-2">#DollarFormat(ContExpTotal)#
        </div>
    </div>
    </CFOUTPUT>
    <cfoutput>
    <div class="form-group">
        ...
        <div class="text-center">
         <button name="Contracts" class="btn btn-primary" id="FindContracts2" tabindex="10"> Contract Details</button>
        </div>
    </div>
...
<CFELSE>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3 col-md-2">#DollarFormat(EncTotal)#</div>
    </div>
   	<div class="form-group">
        <div class="col-sm-offset-3 col-sm-4 col-md-offset-4 col-md-3">
            <label for="TotExpEncumb" id="TotExplbl">Total Expenditures</label>
        </div>
        <div class="col-sm-3 col-md-2">#DollarFormat(ExpTotal)#</div>
    </div>
   	</CFOUTPUT>
	...
	<div class="form-group">
        ...
        <INPUT TYPE="hidden" NAME="Mode" value="#Mode#">
        <div class="text-center">
         <button name="Payments" class="btn btn-primary" id="FindPayments2" tabindex="10"> Payment Details</button>
        </div>
    </div>
    </CFOUTPUT>
</CFIF>
...
<b><u>Issue(s) with Form Submission</u></b>
	...
	<!---<cfif trim(url.NotificationType) is "None" or trim(form.NotificationType) is "None" or trim(ErrorNo) is not "">--->
        ...
        <!--- This code is commented by RK on 12/1/2017 as we have new tab for the Payment Notification --->
        <!---
        <cfoutput>
            ...
            <div class="form-group">
                    ...
                    <div class="has-error">
                      <div class="checkbox">
                        <div class="col-sm-offset-4 col-sm-1 text-right">
                         ...
                         <div class="col-sm-4">
                          	<label>
                          By checking this box I certify that the email and mobile phone number provided are registered to me. I authorize the Office of the Comptroller to send me occasional emails/texts.
                        	</label>
                        </div>
                      </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-offset-5 col-sm-3">
                     <button name="Update" <!---class="btn btn-custom-primary btn-lg btn-block btn-login"---> class="btn btn-danger btn-lg btn-block" id="Loginbtn2" tabindex="10"> Submit</button>
                    </div>
                </div>
