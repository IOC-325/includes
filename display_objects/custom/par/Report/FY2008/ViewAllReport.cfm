...
Created Date: 5-16-07

Modified By: Gary Ashbaugh
Modified Date: 9-29-08
Modifications Made:  Removed all PFY Explanation and Variance Information

Discription: This program will allow the user to view all PAR Reports for a particular Agency.
--->
...
--->
	...
	<cfStoredProc datasource="PAPProd" Procedure="GetPrograms">
		...
		<cfprocparam type="in" cfsqltype="cf_sql_varchar" dbvarname="@ProgramId"  null="yes"">	
	...
	<cfloop query="ThisYear">
		...
		<cfif GetProgramsRetVal is 2>
			<CFLOCATION URL="Errormsg3.cfm?ErrorMsg=#GetProgramsRetMsg#&UrlReturn=menu.cfm">
		</cfif>
		</cfoutput>
	</cfloop>	
	...
	<cfoutput query="InputIndResult">
		<cfif ((PY2Actual is not 0 or PYActual is not 0 or Target is not 0 or Actual is not 0 or NextYrTarget is not 0) and (IndicatorName is "Total expenditures - all sources" or IndicatorName is "Total expenditures - state appropriated funds" or IndicatorName is "Average monthly full-time equivalents")) or (IndicatorName is not "Total expenditures - all sources" and IndicatorName is not "Total expenditures - state appropriated funds" and IndicatorName is not "Average monthly full-time equivalents")>
		<tr>
	...
	<cfif OutcomeIndResult.RecordCount>
		...
		<tr><td align="left" colspan="12"><b><u><font size="-2">Outcome Indicators</font></u></b></td></tr>
	</cfif>
	...
	<cfif GetPriorYrInfoRetVal is 2>
		<CFLOCATION URL="Errormsg3.cfm?ErrorMsg=#GetPriorYrInfoRetMsg#&UrlReturn=menu.cfm">
	</cfif>
	</cfoutput>
	
	<cfoutput>
	<cfStoredProc datasource="PAPProd" Procedure="GetVarianceInfo">
		<cfprocparam type="in" cfsqltype="cf_sql_char" dbvarname="Agency" value="#url.AgencyNo#">
		<cfprocparam type="in" cfsqltype="cf_sql_char" dbvarname="Year" value="#url.ReportCFY#">
		<cfprocparam type="in" cfsqltype="cf_sql_char" dbvarname="ProgramId" value="#url.ReportProgramId#">	
	...
	<cfif GetVarianceInfoRetVal is 2>
		<CFLOCATION URL="Errormsg3.cfm?ErrorMsg=#GetVarianceInfoRetMsg#&UrlReturn=menu.cfm">
	</cfif>
	</cfoutput>
	--->
	
	<cfoutput query="ThisYear">
    <cfif Explanation is not "">
