...
<SCRIPT LANGUAGE="JavaScript"><!--
	function SetFY() {
		...
		self.location.href='#cgi.SCRIPT_NAME#/resources/reports/public-accountability/public-accountability-reports-drilldown/?AgencyNo=' + List.AgencyNo.value + '&ReportFY=' + List.ReportFY.value + '&ReportProgramId=' + List.ReportProgramId.value + '##ViewReports';
			return true;
	}
...
<cfif isDefined("DoListReport")>
	...
	<cfif form.ReportProgramID eq "None">
		
		<p style="color:maroon; font-weight:bold;">Please select a program from the program drop down box. If it does not exist, then choose a different fiscal year, as it is likely that the programs have not yet been submitted for that FY.</p>
...
<cfStoredProc datasource="PAPProd" Procedure="GetAgency">
	...
	<cfprocparam type="in"  cfsqltype="CF_SQL_TIMESTAMP" dbvarname="@Dissolved_Date" value="#TmpDeactivated_Date#">
...
<cfStoredProc datasource="PAPProd" Procedure="GetSubmittedPrograms">
	<cfprocparam type="in" cfsqltype="cf_sql_char" dbvarname="@AgencyNo" value="#url.AgencyNo#">
	<cfprocparam type="in" cfsqltype="cf_sql_char" dbvarname="@FY" value="#url.ReportFY#">
...
<TABLE WIDTH="350" BGCOLOR="#DDEEFF" CELLSPACING="0" CELLPADDING="0" BORDER="1" FRAME="box" RULES="groups">
   ...
   <cfform action="/comptroller/?LinkServID=B760E916-5056-93B5-5E7E0C28BA4B6B65" METHOD="post" NAME="List">
																																		<!---/comptroller/includes/display_objects/custom/par/reportsPopup.cfm?--->
	<tr>
	<TD colspan="3">
		<B>Fiscal Year:</B> <cfselect name="ReportFY"  OnChange="self.location.href='/resources/reports/public-accountability/public-accountability-reports-drilldown/?AgencyNo=' + List.AgencyNo.value + '&ReportFY=' + List.ReportFY.value + '&ReportProgramId=' + List.ReportProgramId.value + '##ViewReports';">
	...
	<TR>
		<TD COLSPAN="3"><B>Agency:</B> 
		<cfselect WIDTH="200" name="AgencyNo" OnChange="self.location.href='/resources/reports/public-accountability/public-accountability-reports-drilldown/?AgencyNo=' + List.AgencyNo.value + '&ReportFY=' + List.ReportFY.value + '&ReportProgramId=' + List.ReportProgramId.value + '##ViewReports';">
		<Option Value="None">&nbsp;</Option>
		<cfoutput query="AgencyList">
		<Option Value="#AgencyNo#" <cfif AgencyList.AgencyNo is url.AgencyNo>Selected</cfif>>#AGCY_Name# (#AgencyNo#)</cfoutput>
		</cfselect>
		</TD>
		</TR>

	<TR>
		<TD colspan="3"><B>Program:</B> <cfselect required="true"  message="Please select a program from the program drop down. If it does not exist, then choose a different fiscal year." name="ReportProgramId" OnChange="self.location.href='/resources/reports/public-accountability/dynamic-public-accountability-reports-menu/?AgencyNo=' + List.AgencyNo.value + '&ReportFY=' + List.ReportFY.value + '&ReportProgramId=' + List.ReportProgramId.value + '##ViewReports';">
		<Option Value="None">&nbsp;</Option>
