                ...
                <cfloop query="CheckRecordLoc">
					...
					<cfif trim(CheckRecordLoc.Approved) is not "">
                    	<cfif TmpButton is "Report Available">
                                <a href="#application.AuditpdfLoc#FY#GetCFY.FY#/#left(url.Code,3)##mid(url.Code,5,3)##right(url.Code,2)#/<cfif trim(folderpath) is not "">#folderpath#/</cfif>#FileName#.pdf"></cfif><span class="glyphicon glyphicon-check"></span>#TmpDesc#</a>
