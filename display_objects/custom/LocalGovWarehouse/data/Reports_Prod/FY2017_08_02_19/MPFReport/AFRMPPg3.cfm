...
<table class="table table-bordered">
    ...
    <div class="text-danger margintop marginb30">^Or provide estimated population<br>*Do not include contractual employees.</div>
    <h5><span class="glyphicon glyphicon-circle-arrow-right"></span> STEPS 5 AND 6: COMPONENT UNITS AND APPROPRIATIONS</h5>
    <b>Provide the appropriation for the primary government listed in the first row of the table below.</b>
    <br>
    In the remaining rows, provide the names of all component units along with their appropriation.
        Indicate if the component units are blended or discretely presented, its fiscal year end date and if the
        component unit was funded with governmental fund types or enterprise fund types. If the component units are
        already indicated, that data is based on forms submitted last year. If you have more component units than the
        rows provided below, please indicate them on an attachment.<br>

    If you need assistance with the terms indicated below, refer to the <i><a
            href="https://www.ioc.state.il.us/ioc-pdf/LocalGovt/AFR2017/2017chartofaccounts.pdf" target="_New">Chart of
        Accounts and Definitions</a></i> and the <i><a
            href="https://www.ioc.state.il.us/ioc-pdf/LocalGovt/AFR2017/2017FAQ_HowtoAll.pdf" target="_New">How to Fill
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <td valign="top"><b>Enterprise Fund Type or Governmental Fund Type</b>
            </td>
        </tr>
    <cfoutput>
        ...
        <td align="right">#NumberFormat(GetAFRRptPg1.Appropriations, "$999,999,999,999,999,999")#</td>
            <td></td>
        <td>#DateFormat(GetAuditInfo.FYEnd, "MM")#
                /#DateFormat(GetAuditInfo.FYEnd, "DD")#</td>
            <td></td></tr>
    </cfoutput>
    <cfoutput query="GetComponentUnitInfo">
        ...
        <td><cfif type is "B">
                Blended<cfelseif type is "DP">Discretely Presented<cfelse></cfif></td>
    ...
    <cfoutput>
            ...
            <td align="right">#NumberFormat(SubApprop, "$9,999,999,999,999,999")#
        </td>
            <td></td>
            <td></td>
            <td></td></tr>
    ...
    <div class="text-danger margintop">Do not enter funds such as: Joint Bridge, Permanent Road, Town
        Fund, Equipment, Water & Sewer, General Assistance, etc. These funds should be included in Step9.<br>^If
        the Primary Government or Component Unit does NOT budget or levy taxes, please enter the unit's TOTAL
        EXPENDITURES.
    </div>
<!---
<center>3<br>
