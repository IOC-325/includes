...
<span class="pull-right"> 
	<a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2017/MPFReportTot/AFRMPPgF7.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Multi-Purpose Form&Page=F7" class="btn btn-primary nomargin">
...
<table class="table table-bordered">
    ...
    <tr>
		...
		<tr><td colspan="5" valign="top" class="center">Report in Whole Numbers</td></tr>
		<cfoutput>
			<tr>
