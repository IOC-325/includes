...
<span class="pull-right"> 
	<a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2017/ABRReport/ABRSPPgF2.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=F2" class="btn btn-primary nomargin">
...
<table class="table table-bordered">
    <tr><td colspan="5" align="center"><b>Disbursements, Expenditures and Expenses</b></td></tr>
    <tr>
		...
		<cfif #Category1# is "251t">
			<tr><td Colspan="5">Report in Whole Numbers</td></tr>
