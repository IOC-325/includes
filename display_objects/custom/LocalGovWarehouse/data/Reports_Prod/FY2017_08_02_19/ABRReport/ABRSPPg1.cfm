...
<cfinclude template="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/Data/Reports/AvailableAFR.cfm">
    ...
    <cfoutput>
        <cfif url.PrintIt is "no">
            <a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2017/ABRReport/ABRSPPg1.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=1"
                class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
            Print This Page</a></span></cfif></cfoutput>
    </h5>

    <div class="text-center"><b>PLEASE CROSS OUT ALL INCORRECT INFORMATION AND PROVIDE CORRECTIONS</b></div>
    ...
    <cfoutput query="GetAFRRptPg1">
            <tr>
                <td colspan="2" valign="top" align="top">A. <b>Contact Person</b> (elected or appointed official
                    responsible for filling out this form)
                </td>
                <td colspan="2" valign="top" align="top">B. <b>Chief Executive Officer</b> (Enter your name here ONLY
                    if you are the elected or appointed official <u>responsible</u> for the EXECUTIVE ADMINISTRATION,
                    i.e. mayor, supervisor, or chairman. Your name will be listed with this responsibility on our
                    website.)
                </td>
                <td colspan="2" valign="top" align="top">C. <b>Chief Financial Officer</b> (Enter your name here ONLY
                    if you are the elected or appointed official <u>responsible</u> for MAINTAINING THE GOVERNMENT'S
                    FINANCIAL RECORDS. Your name will be listed with this responsibility on our website.)
                </td>
                <td colspan="2" valign="top" align="top">D. <b>Purchasing Agent</b> (Enter the Purchasing Agent or if
                    there is no Purchasing Agent, the name of the person responsible for oversight of all competitively
                    bid contracts should be listed)
                </td>
            </tr>
        <tr>
        <td>#FirstName#</td>
    ...
    <td width="40">
        ...
        <td colspan="6">If the Chief Executive Officer and the Chief Financial Officer are the same person as the
...
--->
<!---
	<p><cfoutput><a href="ABRSPPg2.cfm?Code=#url.Code#&CFY=#url.CFY#&FY=#url.FY#&UserName=#url.Code#&C4=#url.C4#&OptionSel=#url.OptionSel#&BetaSel=#BetaSel#&County=#url.County#&GroupBy=#url.GroupBy#&C1=#url.C1#&OrigPage=#url.OrigPage#"></cfoutput><img src="/images/orangebullet.gif" width=16 height=16 border=0 alt="" valign="Center"><b>Proceed to Steps 2 - 3</p></b></a><br>
	--->
    <div class="text-danger margintop">*The contact person listed on the AFRs is for the current Fiscal Year. Previous
        fiscal years may have a different contact person. Please contact the Local Government Division at 877-304-3899
        if you need the contact person for previous years.
    </div>
    <div class="text-danger margintop">*The Annual Financial Reports downloaded from this site may vary from the
        original report. Total on the downloaded form reflect the total of all sub accounts. Other changes may include
        the reported method of accounting.
    </div>
...
<!---<cfinclude template="Menu.cfm"><br><br>--->
    ...
    <cfif url.PrintIt is "No">
        ...
        <td>#url.CFY# Abbreviated Form - 1</td>
        </tr>
        </table>
        </div>
        </cfoutput>
