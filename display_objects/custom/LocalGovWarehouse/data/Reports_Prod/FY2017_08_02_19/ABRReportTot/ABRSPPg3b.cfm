...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2017/ABRReportTot/ABRSPPg3b.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Abbreviated Form&Page=3" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<table class="table table-bordered">
    <cfoutput>
        ...
        <td align="right"><!---#NumberFormat(SubApprop,"$9,999,999,999,999,999")#--->#NumberFormat(GetAFRRptPg1.Appropriations, "$999,999,999,999,999,999")#</td>
        </tr>
    </cfoutput>
    </table>
    </div>
