...
<cfinclude template="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/Data/Reports/AvailableAFR.cfm">
    ...
    <cfoutput>
        <cfif url.PrintIt is "no">
            <a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2017/SPFReport/AFRSPPgF7.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=F10"
...
<tr>
    ...
    <cfif GetAFRRptPg1.LicenseeType is "Individual">
        ...
        <b>If you selected Professional Service Corporation (IL), please complete the licensee
            information below:Please provide the following information for the Professional Service Corporation
