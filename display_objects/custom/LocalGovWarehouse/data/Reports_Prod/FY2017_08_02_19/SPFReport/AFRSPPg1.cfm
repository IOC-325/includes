...
<CFLOCK SCOPE="Session" timeout="100">
    ...
    <cfoutput>
        <cfif url.PrintIt is "no">
            <a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2017/SPFReport/AFRSPPg1.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=1"
    ...
    <cfoutput query="GetAFRRptPg1">
            <tr>
                ...
                <td colspan="2" valign="top" align="top">B. <b>Chief Executive Officer</b> (Enter your name here ONLY if
                    you are the elected or appointed official <u>responsible</u> for the EXECUTIVE ADMINISTRATION, i.e.
                    mayor, supervisor, or chairman. Your name will be listed with this responsibility on our website.)
                </td>
                <td colspan="2" valign="top" align="top">C. <b>Chief Financial Officer</b> (Enter your name here ONLY if
                    you are the elected or appointed official <u>responsible</u> for MAINTAINING THE GOVERNMENT'S
    ...
    <td width="40">
        ...
        <td>If the Chief Executive Officer and the Chief Financial Officer are the same person as the Contact Person,
            please check this box and skip to Step 2. If not, please <u>do not</u> leave columns B and C blank.
        </td></tr>
    </cfoutput>
    </table>
...
<!---<cfinclude template="Menu.cfm"><br><br>--->
    ...
    <cfif url.PrintIt is "No">
        ...
        <td>#url.CFY# Special Purpose Form - 1</td>
        </tr>
        </table>
        </div>
        </cfoutput>
