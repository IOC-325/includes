...
<CFLOCK SCOPE="Session" timeout="100">
    ...
    <tr>
    <td VALIGN="TOP">FY
    <cfoutput>#url.CFY#</cfoutput><br>Annual Financial Report<br>Special Purpose Long Form
</td>
...
<span class="pull-right">
    <cfoutput>
        <cfif url.PrintIt is "no">
            <a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2017/SPFReport/AFRSPCoverPg.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=1"
    ...
    <cfoutput query="GetAFRRptPg1">
        I attest that, to the best of my knowledge, this report represents a complete and accurate statement of the financial position of #UnitName# #Description# as of the end of this fiscal year.
    <br><br><br>
    <hr color="black"><br>
    ...
    <br>
    Is the following information correct and complete? ______ Yes ______ No
    <BR>
    <br>
    ...
    <div class="text-danger margintop">*The contact person listed on the AFRs is for the current Fiscal Year. Previous
        ...
        if you need the contact person for previous years.</div>
