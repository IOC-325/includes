...
<h3 class="clearfix">
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2013/MPFReport/AFRMPPgF9.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=F12" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<cfelseif GetAFRRptPg1.LicenseeType is "Professional" or trim(GetAFRRptPg1.LicenseeType) is "">
    ...
    <tr>
    <td colspan="2">Business Name: #BusinessName#</td>
    </tr>
    <tr>
    <td>Address: #BusinessAddress#</td><td colspan="2">Address 2: #BusinessAddress2#</td>
    </tr>
