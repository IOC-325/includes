...
<Tr><td>
<center><font size="-1" color="black">PLEASE CROSS OUT ALL INCORRECT INFORMATION AND PROVIDE CORRECTIONS</FONT></center></td>
</td></tr>
</table>

<h3>
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2013/RegOnlyReport/RegOnlyPg1.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Registration Form&Page=1" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
