...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2013/MPFReportTot/AFRMPPgF4.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Multi-Purpose Form&Page=F4" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
...
<tr><td><font size="-1"><b><center>Disbursements, Expenditures and Expenses </center></b>&nbsp;</font></td></tr>
		...
		<cfif #Category1# is "251t">
			...
			<tr><td <!--- bgcolor="silver" ---> width="10%"><font size="-1"><b>#DispId#</b>&nbsp;</font></td><td width="65%"><font size="-1"><b><cfif url.PrintIt is "No"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>#DispDescription#<cfif url.PrintIt is "No"></a></cfif></b>&nbsp;</font>&nbsp;&nbsp;</td>
		...
		<cfelseif #Category1# is "252t">
			...
			<tr><td <!--- bgcolor="silver" --->><font size="-1"><b>#DispId#</b>&nbsp;</font></td><td><font size="-1"><b><cfif url.PrintIt is "No"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>#DispDescription#<cfif url.PrintIt is "No"></a></cfif></b>&nbsp;</font>&nbsp;&nbsp;</td>
			<td align="right" bgcolor="gray"><font size="-1">#NumberFormat(TotAmount)#&nbsp;</font></td>
			</tr>
		...
		<cfelseif #Category1# is "260t">
			...
			<tr><td <!--- bgcolor="silver" --->><font size="-1"><b>270t</b></td><td><font size="-1"><b><cfif url.PrintIt is "No"><a href="/Data/Reports/FY2013/MPFReport/AFRMPPGF4.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Total Expenditures/Expense<cfif url.PrintIt is "No"></a></cfif></b></font></td>
			<td align="right"><font size="-1">#Numberformat(IIF (TotalExpenditure is not "",NumberFormat(TotalExpenditure,"999999999999999"),0))#&nbsp;</font></td>
			</tr>
		<cfelse>
