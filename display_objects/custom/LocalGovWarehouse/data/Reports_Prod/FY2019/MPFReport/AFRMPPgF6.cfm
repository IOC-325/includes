...
<h5>
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2019/MPFReport/AFRMPPgF6.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=F6" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
...
<center><font size="-1"><b>Fund Balances and Other Financing Sources (Uses)</b>&nbsp;</font></center>
		...
		<br>
        <!---<p align="right"><font size="-1">F6&nbsp;</font></right>
		<br><center>
...
Multi-Purpose Form&nbsp;</font></center><br><br>--->
    ...
    <cfif url.Menu is "Yes" and url.PrintIt is "no">
     ...
     <cfif url.PrintIt is "No">
        ...
        <td width="5%">&nbsp;</td>
        <td width="20%">#url.CFY# Multi-Purpose Form - F6</td>
         </tr>
        </table>
         </div>
         </cfoutput>
