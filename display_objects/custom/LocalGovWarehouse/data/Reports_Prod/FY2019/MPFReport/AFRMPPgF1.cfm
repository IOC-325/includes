...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2019/MPFReport/AFRMPPgF1.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=F1a" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
     Print This Page</a></span></cfif></cfoutput>
		...
		<cfif #Category1# is "101t">
			...
			<td align="right"><font size="-1">#NumberFormat(GN)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(SR)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(CP)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(DS)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(EP)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(TS)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(FD)#&nbsp;</font></td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right"><font size="-1">#NumberFormat(DP)#&nbsp;</font></td>
			</tr>
		...
		<cfelseif #Category1# is "111t">
			<tr><td <!--- bgcolor="silver" --->><font size="-1"><b>#AssetID#</b>&nbsp;</font></td><td><font size="-1">#AssetDescription#&nbsp;</font>&nbsp;&nbsp;</td>
			<td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right"><font size="-1">#NumberFormat(EP)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(TS)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(FD)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(AG)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(DP)#&nbsp;</font></td>
			</tr>
		...
		<cfelseif #Category1# is "113t">
			<tr><td <!--- bgcolor="silver" --->><font size="-1"><b>#AssetID#</b>&nbsp;</font></td><td><font size="-1">#AssetDescription#&nbsp;</font>&nbsp;&nbsp;</td>
			<td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right"><font size="-1">#NumberFormat(AG)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(DP)#&nbsp;</font></td>
			</tr>
...
<cfoutput query="GetLiabilityCategoryRpt">
	...
	<cfoutput query="GetEquityCategoryRpt">
		...
		<cfif #Category1# is "136t">
			...
			<tr><td <!--- bgcolor="silver" --->><font size="-1"><b>#AssetID#</b>&nbsp;</font></td><td><font size="-1">#AssetDescription#&nbsp;</font>&nbsp;&nbsp;</td>
			<td align="right"><font size="-1">#NumberFormat(GN)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(SR)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(CP)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(DS)#&nbsp;</font></td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right"><font size="-1">#NumberFormat(DP)#&nbsp;</font></td>
			</tr>
		...
		<cfelseif #Category1# is "138t">
			<tr><td <!--- bgcolor="silver" --->><font size="-1"><b>#AssetID#</b>&nbsp;</font></td><td><font size="-1">#AssetDescription#&nbsp;</font>&nbsp;&nbsp;</td>
			<td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right"><font size="-1">#NumberFormat(EP)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(TS)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(FD)#&nbsp;</font></td><td align="right" bgcolor="gray">#NumberFormat(0)#&nbsp;</td><td align="right"><font size="-1">#NumberFormat(DP)#&nbsp;</font></td>
			</tr>
...
--->
    ...
    <cfif url.Menu is "Yes" and url.PrintIt is "no">
	 ...
	 <cfif url.PrintIt is "No">
        ...
        <td width="5%">&nbsp;</td>
        <td width="20%">#url.CFY# Multi-Purpose Form - F1a</td>
         </tr>
        </table>
         </div>
         </cfoutput>
