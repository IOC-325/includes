...
<center><font size="-1" color="black">PLEASE CROSS OUT ALL INCORRECT INFORMATION AND PROVIDE CORRECTIONS</FONT></center>
<h5>
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2019/ABRReport/ABRSPPg1.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=1" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
...
<h5><span class="glyphicon glyphicon-circle-arrow-right"></span><font size="-1" color="black"> STEP 1:  ENTER CONTACT INFORMATION</font>
</h5>
<br>
...
<!---
	...
	<center><font size="-1"><b>Local Government Warehouse Copy</b></font></center>
    <br><br>
    ...
    <cfif url.Menu is "Yes" and url.PrintIt is "no">
     ...
     <cfif url.PrintIt is "No">
        ...
        <td width="5%">&nbsp;</td>
        <td width="20%">#url.CFY# Abbreviated Form - 1</td>
         </tr>
        </table>
         </div>
         </cfoutput>
