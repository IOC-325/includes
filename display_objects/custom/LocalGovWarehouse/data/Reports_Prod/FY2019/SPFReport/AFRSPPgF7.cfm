...
<h3>
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2019/SPFReport/AFRSPPgF7.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=F10" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
...
<table bgcolor="white" cellspacing="2" cellpadding="2" border="1" frame="box"rules="groups">
<tr><cfoutput>
...
<tr><cfoutput>
<td colspan="5"><cfif GetAFRRptPg1.LicenseeType is "Out_Of_State"><img src="#application.LocGovWarehouse#images\CheckedBox.jpg"  align="middle" alt="Out-Of-State Checked"><cfelse><img src="#application.LocGovWarehouse#images\UnCheckBox.jpg"  align="middle"></cfif><font face="Verdana" size="-1">&nbsp;Out-of-State (Individual / Public Accounting Firm / Professional Service Corporation)</font></td>
</cfoutput></tr>
</table>
<br>
...
<br>
<!---<br><p align="right"><font size="-1">F7&nbsp;</font></right>
		<br><center>
...
Special Purpose Form&nbsp;</font></center><br><br>--->
    ...
    <cfif url.PrintIt is "No">
        ...
        <td width="5%">&nbsp;</td>
        <td width="20%">#url.CFY# Special Purpose Form - F10</td>
         </tr>
        </table>
         </div>
         </cfoutput>
