...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2017/SPFReport/AFRSPPg6.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=6" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
     Print This Page</a></span></cfif></cfoutput>
</h5>
<table <!---bgcolor="white" cellspacing="0" cellpadding="2" border="0" bordercolor="black" width="100%"--->>
<tr><td colspan="3">
<font size="-1"><b>List of governmental entities that are part of or related to the primary government.</b>&nbsp;&nbsp;Exclude component units detailed in Steps 5 & 6.  Most small governments do not have governmental entities.</font>
</td></tr>
</table>
...
<br>
<h5>
<span class="glyphicon glyphicon-circle-arrow-right"></span><font size="-1" color="black"> STEP 10:  REPORTING</FONT>
</h5><br>
...
--->
    ...
    <cfif url.PrintIt is "No">
        ...
        <td width="5%">&nbsp;</td>
        <td width="20%">#url.CFY# Special Purpose Form - 6</td>
         </tr>
        </table>
         </div>
         </cfoutput>
