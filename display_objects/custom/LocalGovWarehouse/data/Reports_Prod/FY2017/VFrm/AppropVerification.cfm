...
<!---
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
    <tr>
      ...
      <cfoutput><img src="#application.LocGovWarehouse#images/ComptrollerSealJBT152.jpg" alt="Judy Baar Topinka, Comptroller" width="152" height="101" border="0" align="top"></CFOUTPUT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    ...
    <h5>
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2017/VFrm/AppropVerification.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Verification Form&Page=1" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
	...
	<td width="1%" height="38"  valign="top" align="right">&nbsp;</td>
     <td width="98%" width="38">This document shall serve as official notice to the Office of the Comptroller that <cfoutput>#TmpUnitName#</cfoutput> appropriated^ or budgeted <cfoutput>#NumberFormat(GetUnitStatInfo.TotalAppropriations,"$99,999")#</cfoutput> in FY <cfoutput>#url.cfy#</cfoutput>.<br><font color="red" size="-1">^If the Primary Government does NOT budget or levy taxes, please enter the unit's TOTAL EXPENDITURES.</td>
      ...
      <!---<tr>
      <td height="1" width="100%" align="left" valign="bottom" colspan="3"><cfoutput><img border="0" src="#application.LocGovWarehouse#images/VBlueLine.gif" width="100%" height="1" align="left" valign="bottom" hspace="0"></cfoutput></td>
      </tr>--->
      <tr height="1">
      <!---<td width="1%" height="38" valign="top"><cfoutput><img border="0" src="#application.LocGovWarehouse#images/VBlueLine.gif" width="1" height="100%" align="left" valign="top" hspace="0"></cfoutput></td>--->
      ...
      <!---<td width="1%" height="38"  valign="top" align="right"><cfoutput><img border="0" src="#application.LocGovWarehouse#images/VBlueLine.gif" width="1" height="100%" align="right" valign="top" hspace="0"></cfoutput></td>--->
      <td width="1%" height="38"  valign="top" align="right">&nbsp;</td>
      </tr>
       <tr height="1">
      <!---<td width="1%" height="19" valign="top"><cfoutput><img border="0" src="#application.LocGovWarehouse#images/VBlueLine.gif" width="1" height="100%" align="left" valign="top" hspace="0"></cfoutput></td>--->
     <td width="1%" height="19" valign="top">&nbsp;</td>
     <td width="98%" height="19" valign="top" colspan="2">&nbsp;</td>
      <!---<td width="1%" height="19"  valign="top" align="right"><cfoutput><img border="0" src="#application.LocGovWarehouse#images/VBlueLine.gif" width="1" height="100%" align="right" valign="top" hspace="0"></cfoutput></td>--->
