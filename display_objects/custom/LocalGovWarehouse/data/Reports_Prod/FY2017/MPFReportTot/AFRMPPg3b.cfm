...
<h5>
	<span class="glyphicon glyphicon-circle-arrow-right"></span>
     ...
     <a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2017/MPFReportTot/AFRMPPg3b.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Multi-Purpose Form&Page=3" class="btn btn-primary btn-lg">
...
<!---*</td><td>&nbsp;</td><td align="right"><cfif url.PrintIt is "no"><cfoutput><a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2017/MPFReportTot/AFRMPPg3b.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Multi-Purpose Form&Page=3"><img src="images/printer.jpg" alt="Print Page" width="20" height="20" ></a></cfoutput></cfif>
</td></tr>
<tr><td colspan="3">--->
...
<tr><td width="30%"><font size="-1"><cfif url.PrintIt is "no"><a href="/ProcessSearchResults.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>#GetAFRRptPg1.UnitName# #GetAFRRptPg1.Description#<cfif url.PrintIt is "no"></a></cfif></font></td><td width="15%" align="right"><font size="-1">#NumberFormat(GetAFRRptPg1.Appropriations,"$999,999,999,999,999,999")#</font></td><td width="15%" background="Gray"><font size="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td><td width="15%"><font size="-1">#DateFormat(GetAuditInfo.FYEnd,"MM")#/#DateFormat(GetAuditInfo.FYEnd,"DD")#</font></td><td width="20%"><font size="-1">&nbsp;</font></td></tr>
</cfoutput>
<cfoutput query="GetComponentUnitInfo">
<cfset SubApprop = #iif(SubApprop is "",0,SubApprop)# + #iif(Amount is "",0,Amount)#>
<tr><td width="30%"><font size="-1"><cfif url.PrintIt is "no"><a href="/ProcessSearchResults.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>#ComponentUnit#<cfif url.PrintIt is "no"></a></cfif></font></td><td width="15%" align="right"><font size="-1">#NumberFormat(Amount,"$999,999,999,999,999")#</font></td><td width="15%"><font size="-1"><cfif type is "B">Blended<cfelseif type is "DP">Discretely Presented<cfelse>&nbsp;</cfif></font></td><td width="15%"><font size="-1"><!---<!---#DateFormat(FYEnd,"MM")#/#DateFormat(FYEnd,"DD")#--->#FYEnd#--->#FYEnd#</font></td><td width="20%"><font size="-1">#CU_Funds#</font></td></tr>
</cfoutput>
<cfoutput>
<tr><td width="30%"><font size="-1"><b><cfif url.PrintIt is "no"><a href="/ProcessSearchResults.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Total Appropriations<cfif url.PrintIt is "no"></a></cfif></b></font></td><td width="15%" align="right"><font size="-1">#NumberFormat(SubApprop,"$9,999,999,999,999,999")#</font></td><td width="15%">&nbsp;</td><td width="15%">&nbsp;</td><td width="20%"><font size="-1">&nbsp;</font></td></tr>
</cfoutput>
</table>
