...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2017/MPFReport/AFRMPPg5.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=5" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
     Print This Page</a></span></cfif></cfoutput>
</h5>
<font size="-1"><b>A. List all funds and how much was spent in FY 2017 for each fund.  Also, indicate the Fund Type (Fund Types are at the top of each column beginning on page F1).</b>&nbsp;&nbsp;  If any fund names appear below, that data is based on forms submitted last year.&nbsp;&nbsp;  Please make all necessary corrections.&nbsp;&nbsp;If you have more fund names than the rows provided below, please indicate them on an attachment.</font><br>
...
--->
    ...
    <cfif url.Menu is "Yes" and url.PrintIt is "no">
     ...
     <cfif url.PrintIt is "No">
        ...
        <td width="5%">&nbsp;</td>
        <td width="20%">#url.CFY# Multi-Purpose Form - 5</td>
         </tr>
        </table>
         </div>
         </cfoutput>
