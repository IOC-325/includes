...
<span class="pull-right"> 
	<a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2017/ABRReport/ABRSPPgF1.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=F1" class="btn btn-primary btn-lg">
...
<td align="center" valign="top" width="20%"><font size="-1"><b>General</b>&nbsp;</font></td>
<td align="center" valign="top" width="20%"><font size="-1"><b>Special<br>Revenue</b>&nbsp;</font></td>
<td align="center" valign="top" width="20%"><font size="-1"><b>Other<br>Funds</b>&nbsp;</font></td>
</tr>
		...
		<cfelseif #Category1# is "236t">
			...
			<td align="right"><font size="-1">#Numberformat(IIF (GetTotRevenue.TotRevGN is not "",NumberFormat(GetTotRevenue.TotRevGN,"999999999999999"),0))#&nbsp;</font></td>
			<td align="right"><font size="-1">#Numberformat(IIF (GetTotRevenue.TotRevSR is not "",NumberFormat(GetTotRevenue.TotRevSR,"999999999999999"),0))#&nbsp;</font></td>
			<td align="right"><font size="-1">#Numberformat(IIF (GetTotRevenue.TotRevOT is not "",NumberFormat(GetTotRevenue.TotRevOT,"999999999999999"),0))#&nbsp;</font></td>
			</tr>
		<cfelse>
			<tr><td <!--- bgcolor="silver" --->><font size="-1"><b>#RevenueID#</b>&nbsp;</font></td><td><font size="-1">#RevenueDescription#&nbsp;</font>&nbsp;&nbsp;</td>
			<td align="right"><font size="-1">#NumberFormat(GN)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(SR)#&nbsp;</font></td><td align="right"><font size="-1">#NumberFormat(OT)#&nbsp;</font></td>
		...
		<br>
        <!---<p align="right"><font size="-1">F1&nbsp;</font></right>
		<br><center>
...
--->
    ...
    <cfif url.Menu is "Yes" and url.PrintIt is "no">
     ...
     <cfif url.PrintIt is "No">
        ...
        <td width="5%">&nbsp;</td>
        <td width="20%">#url.CFY# Abbreviated Form - F1</td>
         </tr>
        </table>
         </div>
         </cfoutput>
