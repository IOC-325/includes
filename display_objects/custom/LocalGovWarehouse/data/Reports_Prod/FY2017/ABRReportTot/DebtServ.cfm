...
<span class="pull-right"> 
	<a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2017/ABRReporttot/DebtServ.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Abbreviated Form&Page=F5" class="btn btn-primary btn-lg">
    ...
    <table bgcolor="white" cellspacing="0" cellpadding="2" border="1" frame="box" width="75%">
      ...
      <cfif GetAFRRptPg1.HomeRule is "N">  
        ...
        <cfoutput>
        <tr>
        <td colspan="4" width="45%"><cfif url.PrintIt is "no"> <a href="/ProcessSearchResults.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Total Legal Debt Limitation<cfif url.PrintIt is "no"></a></cfif></td>
        <td colspan="2" align="right" width="13%">#ltrim(rtrim(NumberFormat(GetAFRRptPg1.TotLegalDbtLimit,"$999,999,999,999,999")))#</td>
        <td colspan="2" width="2%">&nbsp;</td>
        <td colspan="5" width="40%">Please provide a summary of the authorized debt limitations, including any statutory references.</td>
        </tr>
        <tr>
        <td colspan="6">&nbsp;</td>
