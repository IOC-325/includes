...
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(DateFormat(IMRF_t500_1,"mm/dd/yyyy")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(DateFormat(IMRF_t500_2,"mm/dd/yyyy")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(DateFormat(IMRF_t500_3,"mm/dd/yyyy")))#</font></p></td>
</tr> 
<tr>
...
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(DateFormat(IMRF_t500a_1,"mm/dd/yyyy")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(DateFormat(IMRF_t500a_2,"mm/dd/yyyy")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(DateFormat(IMRF_t500a_3,"mm/dd/yyyy")))#</font></p></td>
</tr> 
<tr>
...
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(DateFormat(IMRF_t500b_1,"mm/dd/yyyy")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(DateFormat(IMRF_t500b_2,"mm/dd/yyyy")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(DateFormat(IMRF_t500b_3,"mm/dd/yyyy")))#</font></p></td>
</tr> 
<tr>
...
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t501_1,"L999,999,999,999,999")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t501_2,"L999,999,999,999,999")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t501_3,"L999,999,999,999,999")))#</font></p></td>
</tr>
<tr>
...
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t502_1,"L999,999,999,999,999")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t502_2,"L999,999,999,999,999")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t502_3,"L999,999,999,999,999")))#</font></p></td>
</tr>
...
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t503_1,"L999,999,999,999,999")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t503_2,"L999,999,999,999,999")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t503_3,"L999,999,999,999,999")))#</font></p></td>
</tr>	
...
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t504_1,"L9,999,999,999,999.9")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t504_2,"L9,999,999,999,999.9")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t504_3,"L9,999,999,999,999.9")))#</font></p></td>
</tr>	
<tr>
...
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t505_1,"L999,999,999,999,999")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t505_2,"L999,999,999,999,999")))#</font></p></td>
<td width="8%" align="right"><p><font size="-1">#ltrim(rtrim(NumberFormat(IMRF_t505_3,"L999,999,999,999,999")))#</font></p></td>
</tr>
</cfoutput>
</table>	
<br />
