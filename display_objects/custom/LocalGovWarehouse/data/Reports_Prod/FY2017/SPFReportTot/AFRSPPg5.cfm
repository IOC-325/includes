...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2017/SPFReportTot/AFRSPPg5.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Special Purpose Form&Page=5" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
...
<tr><td width="40%"><font size="-1"><cfif url.PrintIt is "No"><a href="/ProcessSearchResults.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>#Instrument#<cfif url.PrintIt is "No"></a></cfif></font></td><td width="20%" align="right"><font size="-1">#NumberFormat(Expenditures,"$999,999,999,999,999")#</font></td><td width="20%"><font size="-1"><cfif FundType is "GN">General<cfelseif FundType is "SR">Special Revenue<cfelseif FundType is "CP">Capital Projects<cfelseif FundType is "DS">Debt Service<cfelseif FundType is "EP">Enterprise<cfelseif FundType is "TS">Internal Service<cfelseif FundType is "FD">Fiduciary<cfelseif FundType is "AG">Account Groups<cfelseif FundType is "DP">Discretely Presented Component Units<cfelse>&nbsp;</cfif></font></td><td width="20%"><font size="-1"><!---<!---#DateFormat(FYEnd,"MM")#/#DateFormat(FYEnd,"DD")#--->#FYEnd#--->#FYEnd#</font></td></tr>
</cfoutput>
<tr><td width="40%"><font size="-1"><b><cfif url.PrintIt is "No"><a href="/ProcessSearchResults.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Total Expenditures<cfif url.PrintIt is "No"></a></cfif></b></font></td><td width="20%" align="right"><font size="-1"><cfoutput>#NumberFormat(TotExp,"$9,999,999,999,999,999")#</cfoutput></font></td><td width="20%">&nbsp;</td><td width="20%">&nbsp;</td></tr>
</table>
<br>
<table<!--- bgcolor="white" cellspacing="0" cellpadding="2" border="0" bordercolor="black" width="100%"--->>
<tr><td>
<font size="-1"><b>B. Does <cfoutput>#GetAFRRptPg1.UnitName# #GetAFRRptPg1.Description#</cfoutput> have assets or liabilities that should be recorded as a part of Account Groups?</b>  See <i><a href="http://www.ioc.state.il.us/ioc-pdf/LocalGovt/AFR2017/2017chartofaccounts.pdf" target="_New">Chart of Accounts and Definitions</a></i> and the <i><a href="http://www.ioc.state.il.us/ioc-pdf/LocalGovt/AFR2017/2017FAQ_HowtoAll.pdf" target="_New">How to Fill Out An AFR</a></i> documents for more information about Account Groups.</font><br>
</td></tr>
<tr><td>
&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.AccountGroups) is "Y"><u>X</u><cfelse>_</cfif>_&nbsp;<cfif url.PrintIt is "No"><a href="/ProcessSearchResults.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Yes<cfif url.PrintIt is "No"></a></cfif>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.AccountGroups) is "N"><u>X</u><cfelse>_</cfif>_&nbsp;<cfif url.PrintIt is "No"><a href="/ProcessSearchResults.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>No<cfif url.PrintIt is "No"></a></cfif>
</td></tr>
</table>
<!---<br>
