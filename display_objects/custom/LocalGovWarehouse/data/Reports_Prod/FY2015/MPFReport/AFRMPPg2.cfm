...
Date Modified: 4-12-04
Modified By: Gary Ashbaugh
Modifications Made:  Added GASB34 question, changed Modified Accrual to Modified Accrual/Accrual, renumbered the questions, and changed - explain to (explain).
...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2015/MPFReport/AFRMPPg2.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=2" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
     Print This Page</a></span></cfif></cfoutput>
</h5>

<cfoutput>FY END DATE:&nbsp;&nbsp;#DateFormat(GetAFRRptPg1.FYEnd,"MM/DD/YYYY")#</cfoutput><br>
...
<br>
<h5>
<span class="glyphicon glyphicon-circle-arrow-right"></span> STEP 3:  GASB 34, ACCOUNTING SYSTEM, DEBT, UTILITY, HOME RULE AND TIF<BR>
</h5><br>
<b>A. Has your government imlemented GASB 34 in <cfoutput>#url.CFY#</cfoutput> reporting or in previous reporting years?</b>&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.GASB34Flag) is "Y"><u>X</u><cfelse>_</cfif>_ Yes&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.GASB34Flag) is "N"><u>X</u><cfelse>_</cfif>_ No<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If yes:
	<ul class="small-font-bullets"><li>Governments who have implemented GASB 34 and are using "other basis of accounting" (OCBOA) such as "Cash Basis" and "Modified Cash Basis" as their accounting system will now be able to select these types as their accounting system.</li>
	<li>Please fill out the Alternative Assets & Liabilities page, located on page F1(b)</li>
</ul>
...
<tr><td align="left">_<cfif AccountingMethod is "Cash"><u>X</u><cfelse>_</cfif>_ Cash - with no assets (Cash Basis)</td><td align="left">_<cfif AccountingMethod is "Modified Accrual"><u>X</u><cfelse>_</cfif>_ Modified Accrual/Accrual</td></tr>
...
<br><br>
<b>F. Is <cfoutput>#GetAFRRptPg1.UnitName# #GetAFRRptPg1.Description#</cfoutput> a home rule unit?&nbsp;</b>_<cfif UCase(GetAFRRptPg1.HomeRule) is "Y"><u>X</u><cfelse>_</cfif>_ Yes&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.HomeRule) is "N"><u>X</u><cfelse>_</cfif>_ No<br>
<br>
<b>G. Does <cfoutput>#GetAFRRptPg1.UnitName# #GetAFRRptPg1.Description#</cfoutput> have a Tax Increment Finance (TIF) district?&nbsp;</b>_<cfif UCase(GetAFRRptPg1.TIF_District) is "Y"><u>X</u><cfelse>_</cfif>_ Yes&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.TIF_District) is "N"><u>X</u><cfelse>_</cfif>_ No<br>
...
--->
    ...
    <cfif url.Menu is "Yes" and url.PrintIt is "no">
     ...
     <cfif url.PrintIt is "No">
        ...
        <td>#url.CFY# Multi-Purpose Form - 2</td>
         </tr>
        </table>
         </div>
         </cfoutput>
