...
<tr>
<td height="1" VALIGN="TOP">FY
    <cfoutput>#url.CFY#</cfoutput> Annual Financial Report Abbreviated Form
</td>
    <td height="75" rowspan="2" valign="top" align="left"><b><u>DO
...
<h5 class="clearfix">
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2015/ABRReport/ABRSPCoverPg.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=1" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<table class="table table-bordered">
<cfoutput query="GetAFRRptPg1">
<tr><td>I attest that, to the best of my knowledge, this report represents a complete and accurate statement of the financial position of #UnitName# #Description# as of the end of this fiscal year.<br><br><br><hr color="black"><br><center>Written signature of government officialDate<br>#FirstName# #LastName#, #Title#<br><b>Please Sign</b></center></td></tr>
</cfoutput>
</table>

<div class="text-center">PLEASE CROSS OUT ALL INCORRECT INFORMATION AND PROVIDE CORRECTIONS</div><br>
...
<table class="table table-bordered">
    <cfoutput query="GetAFRRptPg1">
            <tr>
                <td colspan="2" align="top">A. <b>Contact Person</b> (elected or appointed official
                    responsible for filling out this form):</td>
                <td colspan="2" align="top">B. <b>Chief Executive Officer</b> (elected or appointed
                    official responsible for the executive administration, i.e. mayor, supervisor, or chairman):
                </td>
                <td colspan="2" align="top">C. <b>Chief Financial Officer</b> (elected or appointed
                    official responsible for maintaining the government's financial records):</td>
            </tr>
        <tr>
        <td>#FirstName#</td>
    <td>#LastName#</td>
...
<td width="40">
    ...
    <td>If the Chief Executive Officer and the Chief Financial Officer are the same person
        as the Contact Person, please check this box and skip to Step 2. If not, please <u>do not</u> leave columns B
        and C blank.</td></tr>
</cfoutput>
    </table>

	<div class="text-danger margintop"><b>*The contact person listed on the AFRs is for the current Fiscal Year.  Previous fiscal years may have a different contact person.  Please contact the Local Government Division at 877-304-3899 if you need the contact person for previous years.</b></div>
        <div class="text-danger margintop"><b>*The Annual Financial Reports downloaded from this site may vary from the original report.  Total on the downloaded form reflect the total of all sub accounts.  Other changes may include the reported method of accounting.</b></div>
