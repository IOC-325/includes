...
<cfdocumentitem type="footer"> 
    ...
    <tr><Td width="30%"><font color="navy" size="1" face="Times New Roman, Times, serif"><a href="#application.LocGovWarehouse#">Local Government Warehouse</a> document printed on <cfoutput>#DateFormat(now(),"mm/dd/yyyy")#</cfoutput>.</font></Td>
    <td width="5%">&nbsp;</td>
