...
<Tr>
    ...
    <td>&nbsp;</td>
    <td align="right"><cfif url.PrintIt is "no"><cfoutput><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2018/MPFReport/AFRMPPgF1b.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=F1b"><img src="images/printer.jpg" alt="Print Page" width="20" height="20" ></a></cfoutput></cfif>
	</td>
</tr>
</table>--->
...
<span class="pull-right"> 
	<a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2018/MPFReport/AFRMPPgF1b.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=F1b" class="btn btn-primary nomargin">
     ...
     <cfoutput query="GetAssetCategoryGASB34Rpt">
         ...
         <cfif #Category1# is "101t">
             ...
             <tr>
                 ...
                 <td colspan="4">Report in Whole Numbers</td>
             </tr>
         <tr>
         <td><b>#AssetID#</b></td>
         ...
         <tr>
             <td valign="top"><b>120t</b></td>
             <td valign="top"><b>TOTAL ASSETS</b></td>
         <td align="right" valign="top"><b>
             <cfif GetTotAssetGASB34.TotAsstGA is "">0<cfelse>
                     #NumberFormat(GetTotAssetGASB34.TotAsstGA, "99,999,999,999,999")#</cfif>
             </b></td>
             <td align="right" valign="top"><b>
             <cfif GEtTotAssetGASB34.TotAsstBA is "">0<cfelse>
                     #NumberFormat(GetTotAssetGASB34.TotAsstBA, "99,999,999,999,999")#</cfif>
             </b></td>
             <td align="right" valign="top"><b>
             <cfif GEtTotAssetGASB34.TotAsstFD is "">0<cfelse>
                     #NumberFormat(GetTotAssetGASB34.TotAsstFD, "99,999,999,999,999")#</cfif>
             </b></td>
             <td align="right" valign="top"><b>
             <cfif GetTotAssetGASB34.TotAsstDP is "">0<cfelse>
                     #NumberFormat(GetTotAssetGASB34.TotAsstDP, "99,999,999,999,999")#</cfif>
             </b></td>
             </tr>
             ...
             <td align="center" valign="top"><b>Business-Like Activity</b></td>
             <td align="center" valign="top"><b>Fiduciary</b></td>
             <td align="center" valign="top"><b>Discretely Presented Component Units</b>
             </td></tr>
             <tr>
         ...
         <td align="right">#NumberFormat(DP)#</td>
             ...
             <cfelseif #Category1# is "129t">
                 <tr>
                     <td Colspan="2">NON-CURRENT/LONG-TERM LIABILITIES</td>
                     <td Colspan="4">Report in Whole Numbers</td>
                 </tr>
             <tr>
         <td><b>#AssetID#</b></td>
         ...
         <tr>
             <td valign="top"><b>135t</b></td>
             <td valign="top"><b>TOTAL LIABILITIES</b></td>
         <td align="right" valign="top"><b>
             <cfif GetTotLiabGASB34.TotLiabGA is "">0<cfelse>
                     #NumberFormat(GetTotLiabGASB34.TotLiabGA, "99,999,999,999,999")#</cfif>
             </b></td>
             <td align="right" valign="top"><b>
             <cfif GetTotLiabGASB34.TotLiabBA is "">0<cfelse>
                     #NumberFormat(GetTotLiabGASB34.TotLiabBA, "99,999,999,999,999")#</cfif>
             </b></td>
             <td align="right" valign="top"><b>
             <cfif GetTotLiabGASB34.TotLiabFD is "">0<cfelse>
                     #NumberFormat(GetTotLiabGASB34.TotLiabFD, "99,999,999,999,999")#</cfif>
             </b></td>
             <td align="right" valign="top"><b>
             <cfif GetTotLiabGASB34.TotLiabDP is "">0<cfelse>
                     #NumberFormat(GetTotLiabGASB34.TotLiabDP, "99,999,999,999,999")#</cfif>
             </b></td>
             </tr>
         ...
         <tr>
                 <td  valign="top"><b>146t</b></td>
             <td valign="top"><b>TOTAL NET POSITION</b></td>
         <td align="right" valign="top"><b>
             <cfif GetTotNetAsstGASB34.TotNetAsstGA is "">0<cfelse>
                     #NumberFormat(GEtTotNetAsstGASB34.TotNetAsstGA, "99,999,999,999,999")#</cfif>
             </b></td>
             <td align="right" valign="top"><b>
             <cfif GetTotNetAsstGASB34.TotNetAsstBA is "">0<cfelse>
                     #NumberFormat(GetTotNetAsstGASB34.TotNetAsstBA, "99,999,999,999,999")#</cfif>
             </b></td>
             <td align="right" valign="top"><b>
             <cfif GetTotNetAsstGASB34.TotNetAsstFD is "">0<cfelse>
                     #NumberFormat(GetTotNetAsstGASB34.TotNetAsstFD, "99,999,999,999,999")#</cfif>
             </b></td>
             <td align="right" valign="top"><b>
             <cfif GetTotNetAsstGASB34.TotNetAsstDP is "">0<cfelse>
                     #NumberFormat(GEtTotNetAsstGASB34.TotNetAsstDP, "99,999,999,999,999")#</cfif>
             </b></td>
             </tr>
             <tr>
                     <td valign="top"><b>147t</b></td>
             <td valign="top"><b>TOTAL LIABILITIES & NET POSITION</b>
             </td>
         <td align="right" valign="top"><b>
             <cfif GetTotLiabNetAsstGASB34.TotLiabNetAsstGA is "">0<cfelse>
                     #NumberFormat(GetTotLiabNetAsstGASB34.TotLiabNetAsstGA, "99,999,999,999,999")#</cfif>
             </b></td>
             <td align="right" valign="top"><b>
             <cfif GetTotLiabNetAsstGASB34.TotLiabNetAsstBA is "">0<cfelse>
                     #NumberFormat(GetTotLiabNetAsstGASB34.TotLiabNetAsstBA, "99,999,999,999,999")#</cfif>
             </b></td>
             <td align="right" valign="top"><b>
             <cfif GetTotLiabNetAsstGASB34.TotLiabNetAsstFD is "">0<cfelse>
                     #NumberFormat(GEtTotLiabNetAsstGASB34.TotLiabNetAsstFD, "99,999,999,999,999")#</cfif>
             </b></td>
             <td align="right" valign="top"><b>
             <cfif GetTotLiabNetAsstGASB34.TotLiabNetAsstDP is "">0<cfelse>
                     #NumberFormat(GetTotLiabNetAsstGASB34.TotLiabNetAsstDP, "99,999,999,999,999")#</cfif>
             </b></td>
             </tr>
         </cfif>
     </cfoutput>
...
<div class="row margintop30">
 ...
 <table class="table table-bordered">
		...
		<tr><td>#AssetDescription#</td><td align="right">#NumberFormat(TotPerctSpent,"999.99")#%</td></tr>
		</cfoutput>
