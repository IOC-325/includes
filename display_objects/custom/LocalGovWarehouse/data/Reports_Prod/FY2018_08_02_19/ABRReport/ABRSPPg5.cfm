...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2018/ABRReport/ABRSPPg5.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=5" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
     Print This Page</a></span></cfif></cfoutput>
</h5>

<div><b>A. List all funds and how much was spent in FY 2018 for each fund. Also, indicate the Fund Type (Fund Types are
    at the top of each column beginning on page F1).</b> If any fund names appear below, that data is based on forms
    submitted last year. Please make all necessary corrections. If you have more fund names than the rows provided
    below, please indicate them on an attachment.
</div><br>
