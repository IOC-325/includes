...
<h3 class="clearfix">
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2018/RegOnlyReport/RegOnlyPg1.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Registration Form&Page=1" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<table  class="table table-bordered">
     <cfoutput query="GetAFRRptPg1">
             <tr>
                 <td colspan="2" valign="top" align="top" width="25%">A. <b>Contact Person</b> (elected or appointed
                     official responsible for filling out this form)
                 </td>
                 <td colspan="2" valign="top" align="top" width="25%">B. <b>Chief Executive Officer</b> (Enter your name
                 ...
                 <td colspan="2" valign="top" align="top" width="25%">C. <b>Chief Financial Officer</b> (Enter your name
                 ...
                 <td colspan="2" valign="top" align="top" width="25%">D. <b>Purchasing Agent</b> (Enter the Purchasing
