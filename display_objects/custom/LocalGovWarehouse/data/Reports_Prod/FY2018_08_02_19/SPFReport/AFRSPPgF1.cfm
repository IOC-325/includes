...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2018/SPFReport/AFRSPPgF1.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=F1a" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
     Print This Page</a></span></cfif></cfoutput>
</h3>

<div class="table-responsive-new">
<table class="table table-bordered">
		<tr><td colspan="11" align="center" valign="top"><b>Statement of Financial Position</b></td></tr>
		<tr><td colspan="11" align="center" valign="top"><b>All Funds and Discretely Presented Component Units</b></td></tr>
    <tr>
		...
		<cfif #Category1# is "101t">
			...
			<td align="right">#NumberFormat(GN)#</td><td align="right">#NumberFormat(SR)#</td><td align="right">#NumberFormat(CP)#</td><td align="right">#NumberFormat(DS)#</td><td align="right">#NumberFormat(EP)#</td><td align="right">#NumberFormat(TS)#</td><td align="right">#NumberFormat(FD)#</td><td align="right" bgcolor="gray"></td><td align="right">#NumberFormat(DP)#</td>
			</tr>
		...
		<cfelseif #Category1# is "111t">
			<tr><td><b>#AssetID#</b></td><td>#AssetDescription#</td>
			<td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right">#NumberFormat(EP)#</td><td align="right">#NumberFormat(TS)#</td><td align="right">#NumberFormat(FD)#</td><td align="right">#NumberFormat(AG)#</td><td align="right">#NumberFormat(DP)#</td>
			</tr>
		...
		<cfelseif #Category1# is "113t">
			<tr><td><b>#AssetID#</b></td><td>#AssetDescription#</td>
			<td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right">#NumberFormat(AG)#</td><td align="right">#NumberFormat(DP)#</td>
			</tr>
	...
	<cfoutput query="GetEquityCategoryRpt">
		...
		<cfif #Category1# is "136t">
			...
			<tr><td><b>#AssetID#</b></td><td>#AssetDescription#</td>
			<td align="right">#NumberFormat(GN)#</td><td align="right">#NumberFormat(SR)#</td><td align="right">#NumberFormat(CP)#</td><td align="right">#NumberFormat(DS)#</td><td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right">#NumberFormat(DP)#</td>
			</tr>
		...
		<cfelseif #Category1# is "138t">
			<tr><td><b>#AssetID#</b></td><td>#AssetDescription#</td>
			<td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right" bgcolor="gray"></td><td align="right">#NumberFormat(EP)#</td><td align="right">#NumberFormat(TS)#</td><td align="right">#NumberFormat(FD)#</td><td align="right" bgcolor="gray"></td><td align="right">#NumberFormat(DP)#</td>
			</tr>
...
Special Purpose Form</center>  --->
    ...
    <cfif url.PrintIt is "No">
        ...
        <td>#url.CFY# Special Purpose Form - F1a</td>
         </tr>
        </table>
         </div>
         </cfoutput>
