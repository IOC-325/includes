...
<cfinclude template="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/Data/Reports/AvailableAFR.cfm">
    ...
    <cfoutput>
        <cfif url.PrintIt is "no">
            <a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2018/SPFReport/AFRSPPgF7.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=F10"
...
<tr>
    ...
    <cfif GetAFRRptPg1.LicenseeType is "Individual">
        ...
        <cfoutput query="GetAFRRptPg1">
            <tr>
            <td colspan="3">Enter the active 9-digit License No: #LicenseeNumber# </td>
        ...
        <tr>
        <td>Address: #BusinessAddress#</td>
            <td>Address 2: #BusinessAddress2#</td>
        </tr>
        <tr>
        <td>City: #BusinessCity#</td>
        <td>State: #BusinessState#</td>
