...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2018/SPFReport/AFRSPPg4.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=4" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
     Print This Page</a></span></cfif></cfoutput>
</h5>
<div><b>Indicate any payments
    <cfoutput>#GetAFRRptPg1.UnitName# #GetAFRRptPg1.Description#</cfoutput>
        made to other governments for services or programs (include programs performed on a reimbursement, cost-sharing
        basis or federal payroll taxes).</b></div><br>
    <table class="table table-bordered">
    <cfoutput query="GetAFRRptPg1">
        <tr>
            <td>Intergovernmental agreements - indicate how much was paid</td>
        <td align="right">#NumberFormat(AmtState, "$9,999,999,999,999,999")#</td></tr>
    <tr>
        <td>Federal government payroll taxes</td>
    <td align="right">#NumberFormat(AmtFederal, "$9,999,999,999,999,999")#</td></tr>
    <tr>
        <td>All other intergovernmental payments</td>
    <td align="right">#NumberFormat(AmtLocal, "$9,999,999,999,999,999")#</td></tr>
    </cfoutput>
    </table>
...
--->
	...
	<cfif url.PrintIt is "No">
        ...
        <td>#url.CFY# Special Purpose Form - 4</td>
         </tr>
        </table>
         </div>
         </cfoutput>
