...
<table class="table table-bordered">
    ...
    <h5>
        <span class="glyphicon glyphicon-circle-arrow-right"></span> STEPS 5 AND 6: COMPONENT UNITS AND APPROPRIATIONS
    </h5><br>
