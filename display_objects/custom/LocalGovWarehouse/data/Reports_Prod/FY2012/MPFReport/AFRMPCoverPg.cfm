...
<table class="table-bordered" <!---bgcolor="white" cellspacing="0" cellpadding="2" border="0" width="100%"--->>
  <tr>
    <td width="35%" height="1" VALIGN="TOP"><font size="+2" color="black">FY <cfoutput>#url.CFY#</cfoutput><br>Annual Financial Report</font><br><font size="-1" color="black">Multi-Purpose Long Form</font>
	</td>
...
<h5>
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2012/MPFReport/AFRMPCoverPg.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=1" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
...
<span class="glyphicon glyphicon-circle-arrow-right"></span><font size="-1" color="black"> STEP 1:  ENTER CONTACT INFORMATION</FONT><BR>
<br>
...
<tr><td colspan="7"><font color="red" size="-2"><b>*The contact person listed on the AFRs is for the current Fiscal Year.  Previous fiscal years may have a different contact person.  Please contact the Local Government Division at 877-304-3899 if you need the contact person for previous years.</b></font></td></tr>
<tr><td colspan="7">&nbsp;</td></tr>
<tr><td colspan="7"><font color="red" size="-2"><b>*The Annual Financial Reports downloaded from this site may vary from the original report.  Total on the downloaded form reflect the total of all sub accounts.  Other changes may include the reported method of accounting.</b></font></td></tr>
</cfoutput>
</table>
<br>
<br>
