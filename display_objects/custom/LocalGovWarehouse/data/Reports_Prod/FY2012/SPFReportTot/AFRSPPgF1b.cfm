...
<!--- Added per SR13016 --->
<h6><a href="#PercAmt">View Percentages for Assets/Liabilities/Net Assets</a>
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2012/SPFReportTot/AFRSPPgF1b.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Special Purpose Form&Page=F1b" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
     Print This Page</a></span></cfif></cfoutput>
		...
		<cfelseif #Category1# is "102t" or #Category1# is "115t" or #Category1# is "109t" or #Category1# is "112t">
            ...
            <tr><td <!--- bgcolor="silver" ---> width="10%"><font size="-1"><b>#AssetID#</b></font></td><td width="30%"><font size="-1"><cfif url.PrintIt is "No"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>#AssetDescription#<cfif url.PrintIt is "No"></a></cfif></font>&nbsp;&nbsp;</td>
			<td align="right"><font size="-1">#NumberFormat(TotAmount)#&nbsp;</font></td>
			</tr>
		...
		<cfelseif #Category1# is "149t"><cfset TotNetAsstGASB34=TotNetAsstGASB34 +#TotAmount#>
			...
			<tr><td <!--- bgcolor="silver" ---> width="10%" valign="top"><font size="-1"><b>146t</b></font></td><td width="30%" valign="top"><font size="-1"><b><cfif url.PrintIt is "No"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>TOTAL NET ASSETS<cfif url.PrintIt is "No"></a></cfif></b></font>&nbsp;&nbsp;</td>
			<td align="right"><font size="-1">#NumberFormat(TotNetAsstGASB34)#&nbsp;</font></td>
			</tr>
			<tr><cfset TotLiabNetAsstGASB34=#iif(TotLiabGASB34 is "",0,TotLiabGASB34)# + #iif(TotNetAsstGASB34 is "",0,TotNetAsstGASB34)#><td <!--- bgcolor="silver" ---> width="10%" valign="top"><font size="-1"><b>147t</b></font></td><td width="30%" valign="top"><font size="-1"><b><cfif url.PrintIt is "No"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>TOTAL LIABILITIES & NET ASSETS<cfif url.PrintIt is "No"></a></cfif></b></font>&nbsp;&nbsp;</td>
 ...
 <!---        <div class="row-fluid">
        ...
        <tr><td <!--- bgcolor="silver" --->>Net Assets</td><td <!--- bgcolor="silver" --->>Percentages</td></tr>
