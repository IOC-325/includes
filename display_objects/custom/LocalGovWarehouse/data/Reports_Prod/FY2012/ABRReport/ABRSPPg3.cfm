...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2012/ABRReport/ABRSPPg3.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=3" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<tr><td>^What is the total <b>population</b> of #UnitName# #Description#?</td><td align="right">#NumberFormat(Pop,"999,999,999,999,999")#</td></tr>
<tr><td>What is the total <b>EAV</b> of #UnitName# #Description#?</td><td align="right">#NumberFormat(EAV,"$999,999,999,999,999,999")#</td></tr>
<tr><td>*How many <b>full time employees</b> are paid?</td><td align="right">#NumberFormat(Full_Emp,"999,999,999,999,999,999")#</td></tr>
<tr><td>*How many <b>part time employees</b> are paid?</td><td align="right">#NumberFormat(Part_Emp,"999,999,999,999,999,999")#</td></tr>
<tr><td>What is the <b>total salary</b> paid to all employees?</td><td align="right">#NumberFormat(Salaries,"$999,999,999,999,999,999")#</td></tr>
</cfoutput>
</table>
</div>
...
<h5>
<span class="glyphicon glyphicon-circle-arrow-right"></span> STEPS 5 AND 6: APPROPRIATIONS<BR>
</h5>
<b>Provide the appropriation for the primary government listed in the first row of the table below.</b><br>

If you need assistance with the terms indicated below, refer to the <i><a href="https://www.ioc.state.il.us/ioc-pdf/LocalGovt/AFR2012/2012chartofaccounts.pdf" target="_New">Chart of Accounts and Definitions</a></i> and the <i><a href="https://www.ioc.state.il.us/ioc-pdf/LocalGovt/AFR2012/2012FAQ_HowtoAll.pdf" target="_New">How to Fill Out An AFR</a></i> documents.<br>
<BR>
...
<table class="table table-bordered">
<cfoutput>
<tr><td><b>Total Appropriations</b></td><td align="right">#NumberFormat(GetAFRRptPg1.Appropriations,"$999,999,999,999,999,999")#</td></tr>
</cfoutput>
</table>
</div>
<!---
