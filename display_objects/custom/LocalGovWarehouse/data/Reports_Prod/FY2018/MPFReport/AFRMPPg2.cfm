...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2017/MPFReport/AFRMPPg2.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=2" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
...
<br>
<h5>
<span class="glyphicon glyphicon-circle-arrow-right"></span><font size="-1" color="black"> STEP 3:  GASB 34, ACCOUNTING SYSTEM, DEBT, UTILITY, HOME RULE AND TIF</FONT><BR>
</h5><br>
<br />
...
<br>
<font size="-1"><b>A. Has your government imlemented GASB 34 in <cfoutput>#url.CFY#</cfoutput> reporting or in previous reporting years?</b></font>&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.GASB34Flag) is "Y"><u><font size="-1">X</font></u><cfelse>_</cfif>_ Yes</font>&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.GASB34Flag) is "N"><u><font size="-1">X</font></u><cfelse>_</cfif>_ No</font><br>
<br />
...
<br>
<font size="-1"><b>F. Is <cfoutput>#GetAFRRptPg1.UnitName# #GetAFRRptPg1.Description#</cfoutput> a home rule unit?&nbsp;</b></font>_<cfif UCase(GetAFRRptPg1.HomeRule) is "Y"><u><font size="-1">X</font></u><cfelse>_</cfif>_ <font size="-1">Yes</font>&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.HomeRule) is "N"><u><font size="-1">X</font></u><cfelse>_</cfif>_ <font size="-1">No</font><br>
<br>
<font size="-1"><b>G. Does <cfoutput>#GetAFRRptPg1.UnitName# #GetAFRRptPg1.Description#</cfoutput> have a Tax Increment Finance (TIF) district?&nbsp;</b></font>_<cfif UCase(GetAFRRptPg1.TIF_District) is "Y"><u><font size="-1">X</font></u><cfelse>_</cfif>_ <font size="-1">Yes</font>&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.TIF_District) is "N"><u><font size="-1">X</font></u><cfelse>_</cfif>_ <font size="-1">No</font><br>
<br>
<!---
...
--->
    ...
    <cfif url.Menu is "Yes" and url.PrintIt is "no">
     ...
     <cfif url.PrintIt is "No">
        ...
        <td width="5%">&nbsp;</td>
        <td width="20%">#url.CFY# Multi-Purpose Form - 2</td>
         </tr>
        </table>
         </div>
         </cfoutput>
