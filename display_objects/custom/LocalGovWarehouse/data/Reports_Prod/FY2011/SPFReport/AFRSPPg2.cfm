...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2011/SPFReport/AFRSPPg2.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=2" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<br>
<b>A. Has your government imlemented GASB 34 in <cfoutput>#url.CFY#</cfoutput> reporting or in previous reporting years?</b>&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.GASB34Flag) is "Y"><u>X</u><cfelse>_</cfif>_ Yes&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.GASB34Flag) is "N"><u>X</u><cfelse>_</cfif>_ No<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If yes:
	<ul class="small-font-bullets"><li>Governments who have implemented GASB 34 and are using "other basis of accounting" (OCBOA) such as "Cash Basis" and "Modified Cash Basis" as their accounting system will now be able to select these types as their accounting system.</li><br>
...
<tr><td width="50%" align="left">_<cfif AccountingMethod is "Cash"><u>X</u><cfelse>_</cfif>_ Cash - with no assets (Cash Basis)</td><td width="50%" align="left">_<cfif AccountingMethod is "Modified Accrual"><u>X</u><cfelse>_</cfif>_ Modified Accrual</td></tr>
<tr><td width="50%" align="left">_<cfif AccountingMethod is "Cash With Assets"><u>X</u><cfelse>_</cfif>_ Cash - with assets (Modified Cash Basis)</td><td width="50%" align="left">_<cfif AccountingMethod is "Combination"><u>X</u><cfelse>_</cfif>_ Combination - explain</td></tr>
</cfoutput>
</table>
<br>
<cfoutput query="GetAFRRptPg1">
...
<br>
<table <!---bgcolor="white" cellspacing="0" cellpadding="2" border="0" width="100%"--->>
<tr><td width="34%" align="left">_<cfif UCase(GoBonds) is "Y"><u>X</u><cfelse>_</cfif>_ G.O. Bonds</td><td width="33%" align="left">_<cfif UCase(RevenueBonds) is "Y"><u>X</u><cfelse>_</cfif>_ Revenue Bonds</td><td width="33%" align="left">_<cfif UCase(AlternateRevenueBonds) is "Y"><u>X</u><cfelse>_</cfif>_ Alternate Revenue Bonds</td></tr>
</table>
</cfoutput>
<br>
<cfoutput query="GetAFRRptPg1">
...
<br>
<table <!---bgcolor="white" cellspacing="0" cellpadding="2" border="0" width="100%"--->>
<tr><td width="34%" align="left">_<cfif UCase(ContractualCommitments) is "Y"><u>X</u><cfelse>_</cfif>_ Contractual Commitments</td><td width="66%" align="left">_<cfif UCase(Other) is "Y"><u>X</u><cfelse>_</cfif>_ Other (Explan)&nbsp;<u>#OtherExplan#</u></td></tr>
</table>
</cfoutput>
<br>
<cfoutput query="GetAFRRptPg1">
