...
<Tr>
    ...
    <td></td>
    <td align="right"><cfif url.PrintIt is "no"><cfoutput><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2011/MPFReport/AFRMPPgF1b.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=F1b"><img src="images/printer.jpg" alt="Print Page" width="20" height="20" ></a></cfoutput></cfif>
	</td>
</tr>
</table>--->
...
<span class="pull-right"> 
	<a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2011/MPFReport/AFRMPPgF1b.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=F1b" class="btn btn-primary nomargin">
...
<table class="table table-bordered">
		...
		<cfelseif #Category1# is "149t">
			...
			<tr><td valign="top"><b>147t</b></td><td valign="top"><b>TOTAL LIABILITIES & NET ASSETS</b></td>
