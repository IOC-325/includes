...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2016/MPFReport/AFRMPPg2.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=2" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<br>
<h5>
<span class="glyphicon glyphicon-circle-arrow-right"></span> STEP 3:  GASB 34, ACCOUNTING SYSTEM, DEBT, UTILITY, HOME RULE AND TIF
</h5>
<BR>
...
<cfoutput query="GetAFRRptPg1">
<b>C. Does the government have <u>Bonded</u> debt this reporting fiscal year?</b> _<cfif UCase(BondedDebt) is "Y"><u>X</u><cfelse>_</cfif>_ Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(BondedDebt) is "N"><u>X</u><cfelse>_</cfif>_ No<br><br>
...
<table class="table table-bordered">
<tr><td>_<cfif UCase(ContractualCommitments) is "Y"><u>X</u><cfelse>_</cfif>_ Contractual Commitments</td><td>_<cfif UCase(Other) is "Y"><u>X</u><cfelse>_</cfif>_ Other (Explan)&nbsp;<u>#OtherExplan#</u></td></tr>
</table>
</cfoutput>
