...
<CFLOCK SCOPE="Session" timeout="100">
    ...
    <cfoutput>
        <cfif url.PrintIt is "no">
            <a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2016/MPFReport/AFRMPPgF9.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=F12"
    ...
    <p>According to the Governmental Account Audit Act [50 ILCS 310], an Annual Audit submitted to the IL Office of the
        Comptroller shall be performed by a licensed public accountant, with a valid certificate as a public accountant
        under the Illinois Public Accounting Act [225 ILCS450]. Please access the website of the Illinois General
        Assembly (<a href="https://www.ilga.gov/legislation/ilcs/ilcs.asp">www.ilga.gov/legislation/ilcs/ilcs.asp</a>) to
        view these Acts</p>
    <p>Is the Licensed Certified Public Accountant performing your audit working as an individual licensed in Illinois,
        or are they working in association with a Public Accounting Firm or a Professional Service Corporation licensed
        in Illinois, or are they licensed in another state? Please use a checkmark to select <u>one</u> choice:</p>

    <table class="table table-bordered">
    <tr>
    <cfoutput>
        <td><cfif GetAFRRptPg1.LicenseeType is "Individual">
            <img src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/CheckedBox.jpg"
                align="middle" alt="Individual Checked"><cfelse>
            <img src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/UnCheckBox.jpg"
                align="middle"></cfif>
            &nbsp;Individual Licensed Certified Public Accountant</td>
        <td><cfif GetAFRRptPg1.LicenseeType is "Public">
            <img src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/CheckedBox.jpg"
                align="middle" alt="Public Checked"><cfelse>
            <img src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/UnCheckBox.jpg"
                align="middle"></cfif>
            &nbsp;Public Accounting Firm (IL License)</td>
        <td><cfif GetAFRRptPg1.LicenseeType is "Professional">
            <img src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/CheckedBox.jpg"
    ...
    <tr>
    <td colspan="3">
        <cfoutput><cfif GetAFRRptPg1.LicenseeType is "Out_Of_State">
                <img src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/CheckedBox.jpg"
                    align="middle" alt="Out-Of-State Checked"><cfelse>
                <img src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/UnCheckBox.jpg"
                    align="middle"></cfif>
                &nbsp;Out-of-State (Individual / Public Accounting Firm / Professional
                    Service Corporation)</cfoutput></td>
    </tr>
    </table>

    <cfif GetAFRRptPg1.LicenseeType is "Individual">
        <b>If you selected Individual Licensed Certified Public Accountant (IL), please complete the licensee
            information below:<br>
            Please provide the following information for the Licensed Certified Public Accountant performing the Annual
            Audit for your government. </b>
        ...
        <td>State: #CPA_Contact_State#</td>
            <td>ZIP: #CPA_Contact_ZIP#</td>
        </tr>
        <tr>
        ...
        <b>If you selected Public Accounting Firm (IL), please complete the licensee information below:<br>
            Please provide the following information for the Public Accounting Firm performing the Annual Audit for your
            government.</b>
        <div class="table-responsive">
        <table class="table table-bordered">
        <cfoutput query="GetAFRRptPg1">
        ...
        <td>State: #BusinessState#</td>
            <td>ZIP: #BusinessZIP#</td>
        </tr>
        <tr>
        ...
        <b>If you selected Professional Service Corporation (IL), please complete the licensee information below:<br>
            Please provide the following information for the Professional Service Corporation performing the Annual
            Audit for your government.</b>
        <div class="table-responsive">
        <table class="table table-bordered">
        <cfoutput query="GetAFRRptPg1">
        ...
        <b>If you selected Professional Service Corporation (IL), please complete the licensee
            information below:<br>Please provide the following information for the Professional Service Corporation
            performing the Annual Audit for your government.</b>
        ...
        <b>If you selected Out of State Individual Licensed Certified Public Accountant/ Public Accounting Firm
            /Professional Service Corp, please complete the licensee information below.</b>
        <div class="table-responsive">
        <table class="table table-bordered">
        <cfoutput query="GetAFRRptPg1">
            <tr>
            ...
            <td>License Status: #GetAFRRptPg1.LicenseeStatus#</td>
            </tr>
                <tr>
            ...
            <tr>
            <td><cfif ((GetAFRRptPg1.OutOfState_LicenseeType is not "Individual") and (GetAFRRptPg1.OutOfState_LicenseeType is not "Public") and (GetAFRRptPg1.OutOfState_LicenseeType is not "Professional") and (trim(GetAFRRptPg1.OutOfState_LicenseeType) is not ""))>
                <img src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/CheckedBox.jpg"
                    align="middle" alt="Other Checked"><cfelse>
                <img src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/UnCheckBox.jpg"
                    align="middle"></cfif>&nbsp;Other Business Type&nbsp;&nbsp;&nbsp;
        <u>#GetAFRRptPg1.OutOfState_LicenseeType#</u></td>
        </tr>
             <tr>
        ...
        <td>State: #GetAFRRptPg1.BusinessState#</td>
            <td>ZIP: #GetAFRRptPg1.BusinessZIP#</td>
        </tr>
        <tr>
        ...
        <td>Contact Phone: #GetAFRRptPg1.Contact_Phone#
            ...
            <tr>
                <td colspan="3">Provide information for the Licensed Certified Public Accountant performing the audit
                    for your government.
                </td>
            </tr>
        <tr>
        ...
        <td>State: #GetAFRRptPg1.CPA_Contact_State#</td>
            <td>ZIP: #GetAFRRptPg1.CPA_Contact_ZIP#</td>
        </tr>
        <tr>
...
<!---<br><p align="right"><font size="-1">F9&nbsp;</right>
		<br><center>
...
<!---<cfinclude template="Menu.cfm"><br><br>--->
    ...
    <cfif url.PrintIt is "No">
        ...
        <td>#url.CFY# Multi-Purpose Form - F12</td>
        </tr>
        </table>
        </div>
        </cfoutput>
