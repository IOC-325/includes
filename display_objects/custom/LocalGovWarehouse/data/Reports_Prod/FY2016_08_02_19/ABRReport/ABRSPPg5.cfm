...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2016/ABRReport/ABRSPPg5.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=5" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<tr><td><b>Fund Name</b></td><td><b>Expenditure</b></td><td><b>Fund FundType</b></td><td><b>FY End</b></td></tr>
<cfset TotExp=0><cfoutput query="GetFundsUsed"><cfset TotExp = #iif(TotExp is "",0,TotExp)# + #iif(Expenditures is "",0,Expenditures)#>
<tr><td>#Instrument#</td><td align="right">#NumberFormat(Expenditures,"$999,999,999,999,999")#</td><td><cfif FundType is "GN">General<cfelseif FundType is "SR">Special Revenue<cfelseif FundType is "OT">Other<cfelse>&nbsp;</cfif></td><td>#DateFormat(FYEnd,"MM")#/#DateFormat(FYEnd,"YY")#</td></tr>
</cfoutput>
