...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2016/SPFReport/AFRSPPg3.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=3" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<table class="table table-bordered">
    ...
    <div class="text-danger margintop marginb30">^Or provide estimated population<br>*Do not include contractual employees.</div>
        ...
        In the remaining rows, provide the names of all component units along with their appropriation.  Indicate if the
        component units are blended or discretely presented, its fiscal year end date and if the component unit was
        funded with governmental fund types or enterprise fund types.  If the component units are already indicated,
        that data is based on forms submitted last year.  If you have more component units than the rows provided below,
        please indicate them on an attachment.<br>
        
        If you need assistance with the terms indicated below, refer to the <i><a
            href="https://www.ioc.state.il.us/ioc-pdf/LocalGovt/AFR2016/2016chartofaccounts.pdf" target="_New">Chart of
        Accounts and Definitions</a></i> and the <i><a
            href="https://www.ioc.state.il.us/ioc-pdf/LocalGovt/AFR2016/2016FAQ_HowtoAll.pdf" target="_New">How to Fill
...
<div class="text-danger margintop">*Do not enter funds such as: Joint Bridge, Permanent Road, Town Fund, Equipment, Water & Sewer, General Assistance, etc.  These funds should be included in Step9.<br>^If the Primary Government or Component Unit does NOT budget or levy taxes, please enter the unit's TOTAL EXPENDITURES.
</div>
<!---
<center>3<br>
...
--->
	...
	<cfif url.PrintIt is "No">
        ...
        <td>#url.CFY# Special Purpose Form - 3</td>
         </tr>
        </table>
         </div>
         </cfoutput>
