...
<span class="pull-right"> 
	<a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2016/MPFReportTot/AFRMPPgF7.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Multi-Purpose Form&Page=F7" class="btn btn-primary nomargin">
...
<table class="table table-bordered">
    <tr><td colspan="5" align="center"><b>Statement of Indebtedness</b></td></tr>
		<tr><td align="center" valign="top"><b>Debt Instruments for All Funds</b></td><td align="center" valign="top"><b>Outstanding Beginning of Year</b></td><td align="center" valign="top"><b>Issued Current Fiscal Year</b></td><td align="center" valign="top"><b>Retired Current Fiscal Year</b></td><td align="center" valign="top"><b>Outstanding End of Year</b></td></tr>
		<tr><td colspan="5" valign="top" align="center">Report in Whole Numbers</td></tr>
		<cfoutput>
			<tr>
			...
			<tr>
			<td><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Water<cfif url.PrintIt is "no"></a></cfif></td>
			<td align="right">#NumberFormat(a400)#</td>
			<td align="right">#NumberFormat(a406)#</td>
			<td align="right">#NumberFormat(a412)#</td>
			<td align="right">#NumberFormat(a418)#</td></tr>
			<tr>
			<td><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Electric<cfif url.PrintIt is "no"></a></cfif></td>
			<td align="right">#NumberFormat(b400)#</td>
			<td align="right">#NumberFormat(b406)#</td>
			<td align="right">#NumberFormat(b412)#</td>
			<td align="right">#NumberFormat(b418)#</td>
			</tr>
			<tr>
			<td><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Transportation<cfif url.PrintIt is "no"></a></cfif></td>
			<td align="right">#NumberFormat(c400)#</td>
			<td align="right">#NumberFormat(c406)#</td>
			<td align="right">#NumberFormat(c412)#</td>
			<td align="right">#NumberFormat(c418)#</td>
			</tr>
			<tr>
			<td><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Housing<cfif url.PrintIt is "no"></a></cfif></td>
			<td align="right">#NumberFormat(d400)#</td>
			<td align="right">#NumberFormat(d406)#</td>
			<td align="right">#NumberFormat(d412)#</td>
			<td align="right">#NumberFormat(d418)#</td>
			</tr>
			<tr>
			<td><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Other (Explain)<cfif url.PrintIt is "no"></a></cfif></td>
			<td align="right">#NumberFormat(e400)#</td>
			<td align="right">#NumberFormat(e406)#</td>
			<td align="right">#NumberFormat(e412)#</td>
			<td align="right">#NumberFormat(e418)#</td>
			</tr>
			<tr>
			<td><b><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Revenue Bonds<cfif url.PrintIt is "no"></a></cfif></b></td>
			...
			<tr>
			<td><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Water<cfif url.PrintIt is "no"></a></cfif></td>
			<td align="right">#NumberFormat(a401)#</td>
			<td align="right">#NumberFormat(a407)#</td>
			<td align="right">#NumberFormat(a413)#</td>
			<td align="right">#NumberFormat(a419)#</td>
			</tr>
			<tr>
			<td><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Electric<cfif url.PrintIt is "no"></a></cfif></td>
			<td align="right">#NumberFormat(b401)#</td>
			<td align="right">#NumberFormat(b407)#</td>
			<td align="right">#NumberFormat(b413)#</td>
			<td align="right">#NumberFormat(b419)#</td></tr>
			<tr>
			<td><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Transportation<cfif url.PrintIt is "no"></a></cfif></td>
			<td align="right">#NumberFormat(c401)#</td>
			<td align="right">#NumberFormat(c407)#</td>
			<td align="right">#NumberFormat(c413)#</td>
			<td align="right">#NumberFormat(c419)#</td>
			</tr>
			<tr>
			<td><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Housing<cfif url.PrintIt is "no"></a></cfif></td>
			<td align="right">#NumberFormat(d401)#</td>
			<td align="right">#NumberFormat(d407)#</td>
			<td align="right">#NumberFormat(d413)#</td>
			<td align="right">#NumberFormat(d419)#</td>
			</tr>
			<tr>
			<td><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Other (Explain)<cfif url.PrintIt is "no"></a></cfif></td>
			<td align="right">#NumberFormat(e401)#</td>
			<td align="right">#NumberFormat(e407)#</td>
			<td align="right">#NumberFormat(e413)#</td>
			<td align="right">#NumberFormat(e419)#</td>
			</tr>
			<tr>
