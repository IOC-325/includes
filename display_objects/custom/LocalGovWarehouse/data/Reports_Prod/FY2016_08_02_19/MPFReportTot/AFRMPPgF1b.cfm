...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2016/MPFReportTot/AFRMPPgF1b.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Multi-Purpose Form&Page=F1b" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<table class="table table-bordered">
     ...
     <cfoutput query="GetAssetCategoryGASB34WH">
         ...
         <cfif #Category1# is "101t">
             ...
             <td align="center" valign="top"><b>Enter all Amounts in Whole
                 Numbers</b></td>
         ...
         <td><cfif url.PrintIt is "No">
             <a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No"
                 target="_New"></cfif>#AssetDescription#<cfif url.PrintIt is "No"></a></cfif></td>
         <td align="right">#NumberFormat(TotAmount)#</td>
             ...
             <td><cfif url.PrintIt is "No">
                 <a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No"
                     target="_New"></cfif>#AssetDescription#<cfif url.PrintIt is "No"></a></cfif>
                 </td>
                 <td align="right">#NumberFormat(TotAmount)#</td>
             </tr>
             ...
             <cfset TotAssetGASB34 = TotAssetGASB34 + #TotAmount#>
                 <tr>
                     <td Colspan="6">NON-CURRENT ASSETS</td>
                 </tr>
             <tr>
                     <td><b>#AssetID#</b></td>
         <td>
             <cfif url.PrintIt is "No">
                 <a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No"
                     target="_New"></cfif>#AssetDescription#
         ...
         <td valign="top"><b><cfif url.PrintIt is "No">
             <a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No"
                 target="_New"></cfif>TOTAL ASSETS<cfif url.PrintIt is "No"></a></cfif></b></td>
         <td align="right">#NumberFormat(TotAssetGASB34)#</td>
             ...
             <cfset TotLiabGASB34 = TotLiabGASB34 + #TotAmount#>
                 <tr>
                     <td colspan="6">
                         <center><b>LIABILITIES</b></center>
                     </td>
                 </tr>
             <tr>
                     <td align="center" valign="top"><b>Code</b></td>
         ...
         <td align="right">#NumberFormat(TotAmount)#</td>
             ...
             <cfset TotLiabGASB34 = TotLiabGASB34 + #TotAmount#>
                 <tr>
                     <td Colspan="6">NON-CURRENT/LONG-TERM LIABILITIES</td>
                 </tr>
             <tr>
                     <td><b>#AssetID#</b></td>
         <td>
         ...
         <td  valign="top"><b><cfif url.PrintIt is "No">
             <a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No"
                 target="_New"></cfif>TOTAL LIABILITIES<cfif url.PrintIt is "No"></a></cfif></b></td>
         ...
         <td><cfif url.PrintIt is "No">
             <a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No"
                 target="_New"></cfif>Other Non-Current/Long Term Liabilities<cfif url.PrintIt is "No"></a></cfif>
             </td>
             <td align="right">#NumberFormat(TotAmount)#</td>
         </tr>
         <tr>
         ...
         <td align="right">#NumberFormat(TotLiabGASB34)#</td>
             ...
             <td><cfif url.PrintIt is "No">
                 ...
                 <tr>
                     <td colspan="6">
                         <center><b>NET POSITION</b></center>
                     </td>
                 </tr>
             <tr>
                     <td align="center" valign="top"><b>Code</b></td>
         ...
         <td align="right">#NumberFormat(TotAmount)#</td>
             ...
             <cfelseif #Category1# is "148t">
             <cfset TotNetAsstGASB34 = TotNetAsstGASB34 + #TotAmount#>
                 <tr>
                         <td><b>#AssetID#</b></td>
             <td><cfif url.PrintIt is "No">
                 <a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No"
         ...
         <td valign="top"><b><cfif url.PrintIt is "No">
             <a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No"
                 target="_New"></cfif>TOTAL NET POSITION<cfif url.PrintIt is "No"></a></cfif>
             </b></td>
             <td align="right">#NumberFormat(TotNetAsstGASB34)#</td>
         </tr>
         <tr>
             <cfset TotLiabNetAsstGASB34 = #iif(TotLiabGASB34 is "", 0, TotLiabGASB34)# + #iif(TotNetAsstGASB34 is "", 0, TotNetAsstGASB34)#>
             <td valign="top"><b>147t</b></td>
         <td valign="top"><b><cfif url.PrintIt is "No">
             <a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No"
                 target="_New"></cfif>TOTAL LIABILITIES & NET POSITION<cfif url.PrintIt is "No"></a></cfif>
             </b></td>
...
<!---
		<table bgcolor="White" cellspacing="0" cellpadding="2" border="0" frame="box" "100%">
