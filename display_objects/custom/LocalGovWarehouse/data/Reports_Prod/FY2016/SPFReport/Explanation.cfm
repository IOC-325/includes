...
<span class="pull-right"> 
	<a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2016/SPFReport/Explanation.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=F9" class="btn btn-primary btn-lg">
    ...
    <cfif url.Menu is "Yes" and url.PrintIt is "no">
     ...
     <cfif url.PrintIt is "No">
        ...
        <td width="5%">&nbsp;</td>
        <td width="20%">#url.CFY# Special Purpose Form - F9</td>
         </tr>
        </table>
         </div>
         </cfoutput>
