...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2016/SPFReport/AFRSPPgF1b.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=F1b" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
     Print This Page</a></span></cfif></cfoutput>
		...
		<cfelseif #Category1# is "149t">
			...
			<tr><td <!--- bgcolor="silver" ---> width="10%" valign="top"><font size="-1"><b>147t</b></font></td><td width="30%"><font size="-1"><b>TOTAL LIABILITIES & NET POSITION</b></font>&nbsp;&nbsp;</td>
...
Multi-Purpose Form&nbsp;</font></center><br><br>--->
	...
	<cfif url.PrintIt is "No">
        ...
        <td width="5%">&nbsp;</td>
        <td width="20%">#url.CFY# Special Purpose Form - F1b</td>
         </tr>
        </table>
         </div>
         </cfoutput>
