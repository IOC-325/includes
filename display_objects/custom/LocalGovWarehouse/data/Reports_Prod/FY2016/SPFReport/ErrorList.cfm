...
<span class="pull-right"> 
	<a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2016/MPFReport/ErrorList.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=F13" class="btn btn-primary btn-lg">
...
<cfset ShowHeader = " ">
        ...
        <cfelse>
        	<tr><td><h1><b>Critical</b></h1></td></tr>
        	<tr><td>&nbsp;</td></tr>
         	<tr><td><h1><b>Non-Critical</b></h1></td></tr>
            <tr><td>&nbsp;</td></tr>
        </cfif>
		</table>
