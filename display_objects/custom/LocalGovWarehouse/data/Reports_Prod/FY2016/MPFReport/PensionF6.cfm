...
<span class="pull-right"> 
	<a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2016/MPFReport/PensionF6.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=F9" class="btn btn-primary btn-lg">
...
<br>
<!---<p align="right"><font size="-1">F8&nbsp;</font></p>
<br><center>
...
Multi-Purpose Form&nbsp;</font></center> <br><br>--->
    ...
    <cfif url.Menu is "Yes" and url.PrintIt is "no">
     ...
     <cfif url.PrintIt is "No">
        ...
        <td width="5%">&nbsp;</td>
        <td width="20%">#url.CFY# Multi-Purpose Form - F9</td>
         </tr>
        </table>
         </div>
         </cfoutput>
