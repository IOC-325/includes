...
<h5><span class="glyphicon glyphicon-circle-arrow-right"></span> FUND LISTING & ACCOUNT GROUPS
     ...
     <a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2016/MPFReportTot/AFRMPPg5.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Multi-Purpose Form&Page=5" class="btn btn-primary btn-lg">
...
<tr><td>
&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.AccountGroups) is "Y"><u>X</u><cfelse>_</cfif>_&nbsp;<cfoutput><a href="/ProcessSearchResults.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New">Yes</a></cfoutput>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.AccountGroups) is "N"><u>X</u><cfelse>_</cfif>_&nbsp;<cfoutput><a href="/Data/Reports/FY2016/MPFReport/AFRMPPG5.cfm?Code=#url.Code#&CFY=#url.CFY#&Menu=No">No</a></cfoutput>
</td></tr>
</table>
<!---<br>
