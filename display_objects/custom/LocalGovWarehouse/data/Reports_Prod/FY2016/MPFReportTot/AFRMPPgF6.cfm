...
<h6>
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2016/MPFReportTot/AFRMPPgF6.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Multi-Purpose Form&Page=F6" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
...
<tr><td><font size="-1"><b><center>Fund Balances and Other Financing Sources (Uses)</center></b>&nbsp;</font></td></tr>
		...
		<cfif #Category1# is "302t">	
        	<cfset FndBal301Amount = #NumberFormat(TotFundBal301GN,"9999999999999999")# + #NumberFormat(TotFundBal301SR,"9999999999999999")# + #NumberFormat(TotFundBal301CP,"9999999999999999")# + #NumberFormat(TotFundBal301DS,"9999999999999999")# + #NumberFormat(TotFundBal301EP,"9999999999999999")# + #NumberFormat(TotFundBal301TS,"9999999999999999")# + #NumberFormat(TotFundBal301FD,"9999999999999999")# + #NumberFormat(TotFundBal301DP,"9999999999999999")#>
		...
		<cfelseif #Category1# is "308t">
			...
			<tr><td <!--- bgcolor="silver" --->><font size="-1"><b>310t</b></font></td><td><font size="-1"><b><cfif url.PrintIt is "No"><a href="/ProcessSearchResults.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Current Year Ending Fund Balance (306 + 307 + 308)<cfif url.PrintIt is "No"></a></cfif></b>&nbsp;&nbsp;</font></td>
		...
		<cfelseif #Category1# is "305t">
			...
			<cfset FndBal306Amount = #NumberFormat(TotFundBal306GN,"9999999999999999")# + #NumberFormat(TotFundBal306SR,"9999999999999999")# + #NumberFormat(TotFundBal306CP,"9999999999999999")# + #NumberFormat(TotFundBal306DS,"9999999999999999")# + #NumberFormat(TotFundBal306EP,"9999999999999999")# + #NumberFormat(TotFundBal306TS,"9999999999999999")# + #NumberFormat(TotFundBal306FD,"9999999999999999")# + #NumberFormat(TotFundBal306DP,"9999999999999999")#>
			<tr>
			<td <!--- bgcolor="silver" --->><font size="-1"><b>306t</b>&nbsp;</font></td><td><font size="-1"><b><cfif url.PrintIt is "no"><a href="/ProcessSearchResults.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Net increase (decrease) in fund balance (301t + 302t - 303t + 304t + 305t)<cfif url.PrintIt is "no"></a></cfif></b></font></td>
