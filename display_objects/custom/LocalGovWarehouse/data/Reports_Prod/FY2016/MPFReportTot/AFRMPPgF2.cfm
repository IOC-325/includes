...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/data/reports/PdfReport.cfm?FileName=/data/reports/FY2016/MPFReportTot/AFRMPPgF2.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Multi-Purpose Form&Page=F2" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
...
<tr><td><font size="-1"><b><center>Revenues and Receipts</center></b>&nbsp;</font></td></tr>
		...
		<cfelseif #Category1# is "236t">
			...
			<tr><td <!--- bgcolor="silver" --->><font size="-1"><b>240t</b>&nbsp;</font></td><td><font size="-1"><b><cfif url.PrintIt is "No"><a href="/Data/Reports/FY2016/MPFReport/AFRMPPGF2.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Total Receipts and Revenue<cfif url.PrintIt is "No"></a></cfif></b></font></td>
			<td align="right"><font size="-1">#Numberformat(IIF (TotalRevenue is not "",NumberFormat(TotalRevenue,"999999999999999"),0))#&nbsp;</font></td>
			</tr>
		<cfelse>
