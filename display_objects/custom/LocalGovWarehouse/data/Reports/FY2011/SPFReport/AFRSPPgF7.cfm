...
LOGIC: Pulls off the Auditor information
 ...
 <!---
 <cfinclude template="/AFR/AFR2011/CheckPassExpired.cfm">
 --->
...
<h3 class="clearfix">
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2011/SPFReport/AFRSPPgF7.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=F7" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<tr>
    <cfoutput>
        <td><cfif GetAFRRptPg1.LicenseeType is "Individual">
            ...
            <img src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/UnCheckBox.jpg"
                align="middle"></cfif>&nbsp;Individual Licensed Certified Public Accountant</td>
    ...
    <td><cfif GetAFRRptPg1.LicenseeType is "Professional">
            ...
            <img src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/UnCheckBox.jpg"
                align="middle"></cfif>&nbsp;Professional Service Corporation (IL License)</td>
    </cfoutput></tr>
<tr>
    <cfoutput>
        <td colspan="3"><cfif GetAFRRptPg1.LicenseeType is "Out_Of_State">
            ...
            <img src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/UnCheckBox.jpg"
                align="middle"></cfif>
            &nbsp;Out-of-State (Individual / Public Accounting Firm / Professional Service Corporation)</td>
    </cfoutput></tr>
</table>
