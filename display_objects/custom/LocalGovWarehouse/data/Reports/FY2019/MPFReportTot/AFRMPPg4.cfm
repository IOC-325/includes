...
<h5 class="clearfix"><span class="glyphicon glyphicon-circle-arrow-right"></span> PAYMENTS MADE TO OTHER GOVERNMENTS
     ...
     <a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2019/MPFReportTot/AFRMPPg4.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Multi-Purpose Form&Page=4" class="btn btn-primary nomargin">
