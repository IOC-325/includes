...
<table class="table table-bordered">
    ...
    <tr>
		...
		<cfelseif #Category1# is "236t">
			...
			<tr><td><b>240t</b></td><td><b><cfif url.PrintIt is "No"><a href="/Data/Reports/FY2019/MPFReport/AFRMPPGF2.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Total Receipts and Revenue<cfif url.PrintIt is "No"></a></cfif></b></td>
			<td align="right">#Numberformat(IIF (TotalRevenue is not "",NumberFormat(TotalRevenue,"999999999999999"),0))#</td>
			</tr>
		<cfelse>
