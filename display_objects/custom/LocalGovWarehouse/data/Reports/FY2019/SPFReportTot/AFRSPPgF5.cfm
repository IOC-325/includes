...
<span class="pull-right"> 
	<a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2019/SPFReporttot/AFRSPPgF5.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Special Purpose Form&Page=F5" class="btn btn-primary nomargin">
...
<table class="table table-bordered">
    ...
    <tr>
		...
		<tr><td colspan="5" valign="top">Report in Whole Numbers</td></tr>
		<cfoutput>
			<tr>
