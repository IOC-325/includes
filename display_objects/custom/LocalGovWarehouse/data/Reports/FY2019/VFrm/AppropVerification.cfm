...
<!---
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
    ...
    <h5 class="clearfix">
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2019/VFrm/AppropVerification.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Verification Form&Page=1" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<table class="table table-bordered">
    <tr>
        <td colspan="3" valign="top">Please complete the following information (please make
            changes if necessary):</td>
    </tr>
<tr>
    <td>First Name:</td>
...
<div class="text-danger">^If the Primary Government does NOT budget or levy taxes, please enter the unit's TOTAL EXPENDITURES.</div>
 ...
 _______________________________________   Date ________________<br>
...
<div class="margintop marginb20">
    <cfoutput>#TmpUnitName# (#url.code#) has successfully submitted their FY #url.cfy# Verification Form to the Office of the State Comptroller on #DateFormat(GetUnitStatInfo.Date_Finished,"mm/dd/yyyy")# <cfif GetUnitStatInfo.Date_Resubmitted is not ""> and re-submitted on #DateFormat(GetUnitStatInfo.Date_Resubmitted,"mm/dd/yyyy")#</cfif>.  Please print and keep a copy of this screen for your records.</cfoutput>
    </div>
