...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2019/ABRReport/ABRSPPg3.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=3" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<table class="table table-bordered">
    <cfoutput query="GetAFRRptPg1">
        <tr>
        <td align="left">^What is the total <b>population</b> of #UnitName# #Description#
            ?</td>
    ...
    <tr>
        <td align="left">*How many <b>full time employees</b> are paid?</td>
    <td align="right">#NumberFormat(Full_Emp, "999,999,999,999,999,999")#
            </td></tr>
        <tr>
            <td align="left">*How many <b>part time employees</b> are paid?</td>
        <td align="right">#NumberFormat(Part_Emp, "999,999,999,999,999,999")#
            </td></tr>
        <tr>
            <td align="left">What is the <b>total salary</b> paid to all employees?
            </td>
        <td align="right">#NumberFormat(Salaries, "$999,999,999,999,999,999")#
            </td></tr>
    </cfoutput>
    </table>
    </div>
    ...
    <h5><span class="glyphicon glyphicon-circle-arrow-right"></span> STEPS 5 AND 6: APPROPRIATIONS</h5>
    ...
    If you need assistance with the terms indicated below, refer to the <i><a
            href="https://illinoiscomptroller.gov/ioc-pdf/LocalGovt/AFR2019/2019chartofaccounts.pdf" target="_New">Chart of
        Accounts and Definitions</a></i> and the <i><a
            href="https://illinoiscomptroller.gov/ioc-pdf/LocalGovt/AFR2019/2019FAQ_HowtoAll.pdf" target="_New">How to Fill
    ...
    <cfoutput>
            ...
            <td align="right">#NumberFormat(GetAFRRptPg1.Appropriations, "$999,999,999,999,999,999")#
        </td></tr>
    </cfoutput>
    </table>
    </div>
