...
<cfparam name="url.PrintIt" default="No">
  ...
  <tr>
    <td VALIGN="TOP">FY <cfoutput>#url.CFY#</cfoutput><br>Annual Financial Report<br>Abbreviated Form
	</td>
...
<h5 class="clearfix">
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2019/ABRReport/ABRSPCoverPg.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=1" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<br>
Is the following information correct and complete? ______ Yes ______ No<BR><BR>
...
<table class="table table-bordered">
    ...
    <tr>
    <td colspan="2">E-mail: <span class="emailid-wrap">#Email_Gov#</td>
    <td colspan="2">E-mail: <span class="emailid-wrap">#CEOEmail#</td>
    <td colspan="2">E-mail: <span class="emailid-wrap">#CFOEmail#</td></tr>
    </table>
    </div>
