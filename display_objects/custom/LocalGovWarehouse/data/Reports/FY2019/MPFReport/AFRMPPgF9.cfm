...
<h3 class="clearfix">
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2019/MPFReport/AFRMPPgF9.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=F12" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<cfelseif GetAFRRptPg1.LicenseeType is "Professional" or trim(GetAFRRptPg1.LicenseeType) is "">
    ...
    <b>If you selected Professional Service Corporation (IL), please complete the licensee
        ...
        Please provide the following information for the Professional Service Corporation performing
...
<cfelseif GetAFRRptPg1.LicenseeType is "Out_Of_State">
    ...
    <tr>
    <td colspan="3">CPA Last Name: #GetAFRRptPg1.CPA_Contact_LName#</td>
