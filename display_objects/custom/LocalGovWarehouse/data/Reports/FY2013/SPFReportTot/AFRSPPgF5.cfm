...
<span class="pull-right"> 
	<a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2013/SPFReporttot/AFRSPPgF5.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Special Purpose Form&Page=F5" class="btn btn-primary btn-lg">
...
<tr><td><font size="-1"><b><center>Statement of Indebtedness</center></b>&nbsp;</font></td></tr>
		...
		<cfoutput>
			...
			<tr>
			<td><font size="-1"><b><cfif url.PrintIt is "No"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Revenue Bonds<cfif url.PrintIt is "No"></a></cfif></b>&nbsp;&nbsp;</p></td>
