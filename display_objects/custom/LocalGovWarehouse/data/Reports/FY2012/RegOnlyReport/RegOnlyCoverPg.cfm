...
<table class="table-bordered" <!---bgcolor="white" cellspacing="0" cellpadding="2" border="0" width="100%"--->>
  <tr>
    <td width="35%" height="1" VALIGN="TOP"><font size="+2" color="black">FY <cfoutput>#url.CFY#</cfoutput><br>Registration Form</font>
	</td>
    <td width="43%" height="75" rowspan="2" valign="top" align="left"><b><font size="-2"><u>DO
      ...
      THE COMPTROLLER'S OFFICE WITH A COPY OF YOUR REGISTRATION.</font></b></td>
  </tr>
  <tr><td colspan="2">&nbsp;</td></tr>
</table><b><br />
<h3>
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2012/RegOnlyReport/RegOnlyCoverPg.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Registration Form&Page=1" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
...
<cfoutput query="GetAFRRptPg1">
<tr><td><font size="-1">I attest that, to the best of my knowledge, this report represents a complete and accurate registration information for #UnitName# #Description# as of the end of this fiscal year.<br><br><br><hr color="black"><br><center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Written signature of government official&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date<br>#FirstName# #LastName#, #Title#&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><b>Please Sign&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></center></font></td></tr>
</cfoutput>
</table>
...
<tr><td colspan="2"><font size="-1">E-mail: #Email_Gov#</font></td><td colspan="2"><font size="-1">E-mail: #CEOEmail#</font></td><td colspan="2"><font size="-1">E-mail: #CFOEmail#</font></td></tr></cfoutput>
</table>
<br>
<br>
