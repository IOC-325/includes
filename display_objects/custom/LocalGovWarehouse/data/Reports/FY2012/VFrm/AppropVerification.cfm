...
<!---
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
    ...
    <h5>
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2012/VFrm/AppropVerification.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Verification Form&Page=1" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
    ...
    <tr width="100%">
	  ...
	  <tr >
		<td width="1%" >&nbsp;</td>
     	<td width="98%">The Government Audit Act exempts special purpose governments that appropriate or budget less than <cfoutput>#NumberFormat(GetExemptApprop.CheckAppropriation,"$99,999")#</cfoutput> in FY <cfoutput>#url.cfy#</cfoutput> from filing an Annual Financial Report with the Office of the Comptroller.</td>
		<td width="1%">&nbsp;</td>
      </tr>
	   <tr >
      <td colspan="3">&nbsp;</td>
	...
	<td width="1%"   valign="top" >&nbsp;</td>
     <td width="98%" >This document shall serve as official notice to the Office of the Comptroller that <cfoutput>#TmpUnitName#</cfoutput> appropriated^ or budgeted <cfoutput>#NumberFormat(GetUnitStatInfo.TotalAppropriations,"$99,999")#</cfoutput> in FY <cfoutput>#url.cfy#</cfoutput>.</td>
     <td width="1%"   valign="top" >&nbsp;</td>
     </tr>
     <tr >
	<td width="1%"   valign="top" >&nbsp;</td>
     <td width="98%" ><font color="red" size="-1">^If the Primary Government does NOT budget or levy taxes, please enter the unit's TOTAL EXPENDITURES.</td>
		<td width="1%"   valign="top" >&nbsp;</td>
      </tr>
	   <tr >
      <td colspan="3">&nbsp;</td>
      ...
      <!---<tr>
      <td  width="100%" align="left" valign="bottom" colspan="3"><cfoutput><img border="0" src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/VBlueLine.gif" width="100%"  align="left" valign="bottom" hspace="0"></cfoutput></td>
      </tr>--->
      <tr >
      <!---<td width="1%"  valign="top"><cfoutput><img border="0" src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/VBlueLine.gif" width="1" height="100%" align="left" valign="top" hspace="0"></cfoutput></td>--->
    	<td width="1%"  valign="top">&nbsp;</td>
    	<td width="98%"  valign="top" colspan="3"><font size="2">I attest that, to the best of my knowledge, this document represents the financial position of the government as of the end of this fiscal year.</font></td>
      <!---<td width="1%"   valign="top" align="right"><cfoutput><img border="0" src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/VBlueLine.gif" width="1" height="100%" align="right" valign="top" hspace="0"></cfoutput></td>--->
    ...
    <td width="1%" height="19"  valign="top" align="right">&nbsp;</td>
     ...
     <td width="1%" height="19"  valign="top" align="right">&nbsp;</td>
      ...
      <tr >
      <!---<td  width="100%" align="left" valign="bottom" colspan="3"><cfoutput><img border="0" src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/VBlueLine.gif" width="100%"  align="left" valign="bottom" hspace="0"></cfoutput></td>--->
      <td  width="100%" align="left" valign="bottom" colspan="3">&nbsp;</td>
      </tr>
