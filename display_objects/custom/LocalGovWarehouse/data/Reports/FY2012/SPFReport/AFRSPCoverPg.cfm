...
<h3>
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2012/SPFReport/AFRSPCoverPg.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=1" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-print"></span>
...
<br><br>
    ...
    <cfif url.PrintIt is "No">
        ...
        <td width="5%">&nbsp;</td>
        <td width="20%"><font color="navy" size="1" face="Times New Roman, Times, serif">#url.CFY# #url.Format# - #Page#</font></td>
         </tr>
        </table>
         </div>
         </cfoutput>
