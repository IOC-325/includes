...
<h3 class="clearfix">
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2012/MPFReport/AFRMPPgF9.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=F9" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<cfelseif GetAFRRptPg1.LicenseeType is "Public">
    ...
    <b>If you selected Professional Service Corporation (IL), please complete the licensee information below:<br>
        Please provide the following information for the Professional Service Corporation performing the Annual Audit
        for your government.</b>
    <div class="table-responsive">
    <table class="table table-bordered">
    <cfoutput query="GetAFRRptPg1">
        <tr>
...
<table class="table table-bordered">
    ...
    <td>Address: #GetAFRRptPg1.BusinessAddress#</td>
        <td>Address 2: #GetAFRRptPg1.BusinessAddress2#</td>
    </tr>
    <tr>
