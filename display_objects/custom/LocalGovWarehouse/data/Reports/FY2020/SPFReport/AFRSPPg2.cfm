...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2020/SPFReport/AFRSPPg2.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=2" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<br>
<h5><span class="glyphicon glyphicon-circle-arrow-right"></span> STEP 3:  GASB 34, ACCOUNTING SYSTEM, AND DEBT</h5>
<br />
...
<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If "Yes", indicate the type(s) of debt <u>and</u> complete the Statement of Indebtedness page, located on page F7.</b><br>
<table class="table table-bordered">
<tr><td>_<cfif UCase(ContractualCommitments) is "Y"><u>X</u><cfelse>_</cfif>_ Contractual Commitments</td><td>_<cfif UCase(Other) is "Y"><u>X</u><cfelse>_</cfif>_ Other (Explian)&nbsp;<u>#OtherExplan#</u></td></tr>
</table>
</cfoutput>
