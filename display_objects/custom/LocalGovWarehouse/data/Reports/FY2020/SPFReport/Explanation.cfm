...
<span class="pull-right"> 
	<a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2020/SPFReport/Explanation.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=F9" class="btn btn-primary nomargin">
    ...
    <cfif url.Menu is "Yes" and url.PrintIt is "no">
     ...
     <cfif url.PrintIt is "No">
        ...
        <td>#url.CFY# Special Purpose Form - F9</td>
         </tr>
        </table>
         </div>
         </cfoutput>
