...
<table class="table table-bordered">
    <tr>
		...
		<cfelseif #Category1# is "260t">
			...
			<tr><td><b>270t</b></td><td><b><cfif url.PrintIt is "No"><a href="/Data/Reports/FY2020/MPFReport/AFRMPPGF4.cfm?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>Total Expenditures/Expense<cfif url.PrintIt is "No"></a></cfif></b></td>
			<td align="right">#Numberformat(IIF (TotalExpenditure is not "",NumberFormat(TotalExpenditure,"999999999999999"),0))#</td>
			</tr>
		<cfelse>
