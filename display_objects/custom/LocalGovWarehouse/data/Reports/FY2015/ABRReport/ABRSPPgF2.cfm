...
<span class="pull-right"> 
	<a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2015/ABRReport/ABRSPPgF2.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=F2" class="btn btn-primary nomargin">
...
<table class="table table-bordered">
    ...
    <cfoutput query="GetExpCategoryAbbrPgF2Rpt">
        ...
        <cfif #Category1# is "251t">
                <tr>
                    <td Colspan="3" align="center">Report in Whole Numbers</td>
                </tr>
            <tr>
            <td><b>#DispID#</b></td>
        <td>#DispDescription#</td>
        <td align="right">#NumberFormat(GN)#</td>
        <td align="right">#NumberFormat(SR)#</td>
        <td align="right">#NumberFormat(OT)#</td>
        </tr>
        ...
        <tr>
            <td><b>270t</b></td>
            <td><b>Total Expenditures/Expense</b></td>
