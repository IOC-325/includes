...
<span class="pull-right"> 
	<a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2015/ABRReport/ABRSPPgF3.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=F3" class="btn btn-primary nomargin">
...
<table class="table table-bordered">
    <tr>
        <td colspan="5" align="center"><b>Fund Balances and Other Financing Sources (Uses)</b></td>
    </tr>
<tr>
        ...
        <td align="center" valign="top"><b>Other Funds</b></td></tr>
