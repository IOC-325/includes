...
LOGIC: Pulls off the Auditor information
 ...
 <!---
 <cfinclude template="/AFR/AFR2015/CheckPassExpired.cfm">
 --->
...
<h3 class="clearfix">
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2015/SPFReport/AFRSPPgF7.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=F10" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<table class="table table-bordered">
    <cfoutput query="GetAFRRptPg1">  
    <tr>
    <td colspan="3">Enter the active 9-digit License No: #Prof_CPALicenseeNumber#</td>
