...
<span class="pull-right"> 
	<a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2015/SPFReport/Pension.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=F7" class="btn btn-primary nomargin">
...
<cfoutput>
        <tr><td colspan="11" align="center"><b>Pension Funds / Retirement Benefits</b></tr>
...
<tr>
<td>Actuarial Valuation Date (500)</td>
...
<tr>
<td>Total Pension Liability / Actuarial Accrued Liability (501)</td>
...
<td align="right">#ltrim(rtrim(NumberFormat(Police_t501_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Police_t501_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Police_t501_3,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t501_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t501_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t501_3,"L999,999,999,999,999")))#</td>
<td>Total Pension Liability / Actuarial Accrued Liability (501)</td>
</tr>
<tr>
<td>Total Funded Pension / Actuarial Value of Assets (502)</td>
...
<td align="right">#ltrim(rtrim(NumberFormat(Police_t502_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Police_t502_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Police_t502_3,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t502_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t502_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t502_3,"L999,999,999,999,999")))#</td>
<td>Total Funded Pension / Actuarial Value of Assets (502)</td>
</tr>
<!--- Calculated field (501-502) - User should NOT be able to change values. --->
<tr>
<td>Total Unfunded Pension Liability (503)</td>
...
<td align="right">#ltrim(rtrim(NumberFormat(Police_t503_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Police_t503_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Police_t503_3,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t503_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t503_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t503_3,"L999,999,999,999,999")))#</td>
<td>Total Unfunded Pension Liability (503)</td>
</tr>	
<!--- Calculated field (502/501*100) - User should NOT be able to change values. --->
<tr>
<td>Funded Ratio (504)</td>
...
<td align="right">#ltrim(rtrim(NumberFormat(Police_t504_1,"L9,999,999,999,999.9")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Police_t504_2,"L9,999,999,999,999.9")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Police_t504_3,"L9,999,999,999,999.9")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t504_1,"L9,999,999,999,999.9")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t504_2,"L9,999,999,999,999.9")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t504_3,"L9,999,999,999,999.9")))#</td>
<td>Funded Ratio (504)</td>
</tr>	
<tr>
...
<td align="right">#ltrim(rtrim(NumberFormat(Police_t505_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Police_t505_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Police_t505_3,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t505_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t505_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Fire_t505_3,"L999,999,999,999,999")))#</td>
<td>Net Pension Obligation / Net OPEB Obligation (505)</td>
</tr>
    </cfoutput>
    </table>
...
<tr>
<td>Total Pension Liability / Actuarial Accrued Liability (501)</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t501_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t501_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t501_3,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t501_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t501_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t501_3,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t501_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t501_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t501_3,"L999,999,999,999,999")))#</td>
<td>Total Pension Liability / Actuarial Accrued Liability (501)</td>
</tr>
<tr>
<td>Total Funded Pension / Actuarial Value of Assets (502)</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t502_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t502_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t502_3,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t502_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t502_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t502_3,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t502_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t502_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t502_3,"L999,999,999,999,999")))#</td>
<td>Total Funded Pension / Actuarial Value of Assets (502)</td>
</tr>
<!--- Calculated field (501-502) - User should NOT be able to change values. --->
<tr>
<td>Total Unfunded Pension Liability (503)</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t503_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t503_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t503_3,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t503_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t503_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t503_3,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t503_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t503_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t503_3,"L999,999,999,999,999")))#</td>
<td>Total Unfunded Pension Liability (503)</td>
</tr>
<!--- Calculated field (501/502*100) - User should NOT be able to change values. --->
<tr>
<td>Funded Ratio (504)</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t504_1,"L9,999,999,999,999.9")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t504_2,"L9,999,999,999,999.9")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t504_3,"L9,999,999,999,999.9")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t504_1,"L9,999,999,999,999.9")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t504_2,"L9,999,999,999,999.9")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t504_3,"L9,999,999,999,999.9")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t504_1,"L9,999,999,999,999.9")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t504_2,"L9,999,999,999,999.9")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t504_3,"L9,999,999,999,999.9")))#</td>
<td>Funded Ratio (504)</td>
</tr>
<tr>
<td>Net Pension Obligation / Net OPEB Obligation (505)</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t505_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t505_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(SLEP_t505_3,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t505_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t505_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(Other_t505_3,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t505_1,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t505_2,"L999,999,999,999,999")))#</td>
<td align="right">#ltrim(rtrim(NumberFormat(OPEB_t505_3,"L999,999,999,999,999")))#</td>
<td>Net Pension Obligation / Net OPEB Obligation (505)</td>
</tr>
</cfoutput>
</table>
...
Special Purpose Form&nbsp;</center>
 ...
 --->
	...
	<cfif url.PrintIt is "No">
        ...
        <td>#url.CFY# Special Purpose Form - F7</td>
         </tr>
        </table>
         </div>
         </cfoutput>
