...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2015/RegOnlyReport/RegOnlyPg2.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Registration Form&Page=2" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
     Print This Page</a></span></cfif></cfoutput>
</h5>
<cfoutput>FY END DATE:&nbsp;&nbsp;#DateFormat(GetAFRRptPg1.FYEnd,"MM/DD/YYYY")#</cfoutput><br>
<br>
<h5>
<span class="glyphicon glyphicon-circle-arrow-right"></span> STEP 3:  POPULATION AND EAV
</h5><br>
...
<table  class="table table-bordered">
    <cfoutput query="GetAFRRptPg1">
        <tr>
        <td align="left">^What is the total <b>population served/school enrollment</b>
            of #UnitName# #Description#?</td>
    <td align="right">#NumberFormat(Pop, "999,999,999,999,999")#&nbsp;</td></tr>
    <tr>
    <td align="left">What is the total <b>EAV</b> of #UnitName# #Description#?</td>
    ...
    <h5>
        <span class="glyphicon glyphicon-circle-arrow-right"></span> STEPS 4 AND 5:
        COMPONENT UNITS AND APPROPRIATIONS
    </h5>
    <b>Provide the appropriation for the primary government listed in the first row of the table
        below.</b><br>
    <br>
    If you are a primary unit of government, provide your Unit name and appropriation in the first row
        of the table below and list any component unit(s):<br>
    <br>
    <div class="table-responsive">
    <table  class="table table-bordered">
        <tr>
    ...
    <cfoutput>
        ...
        <td>#DateFormat(GetAuditInfo.FYEnd, "MM")#
                /#DateFormat(GetAuditInfo.FYEnd, "DD")#</td></tr>
    </cfoutput>
    ...
    <div class="text-danger margintop">*Do not enter funds such as: Joint Bridge, Permanent Road, Town
        Fund, Equipment, Water & Sewer, General Assistance, etc.
    <br>
    *Do not enter funds such as: Joint Bridge, Permanent Road, Town
        Fund, Equipment, Water & Sewer, General Assistance, etc.
        <br>^If the Primary Government
        or Component Unit does NOT budget or levy taxes, please enter the unit's TOTAL EXPENDITURES.
    </div>
...
<tr>
    <cfoutput>
        ...
        <img src="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/images/UnChecked.jpg"
            ...
            Component unit files financial information separately from the primary government
        </td>
    </cfoutput></tr>
<tr>
    <cfoutput>
