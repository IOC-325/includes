...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2018/MPFReport/AFRMPPg2.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Multi-Purpose Form&Page=2" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<br>
<b>G. Does <cfoutput>#GetAFRRptPg1.UnitName# #GetAFRRptPg1.Description#</cfoutput> have a Tax Increment Finance (TIF) district?&nbsp;</b>_<cfif UCase(GetAFRRptPg1.TIF_District) is "Y"><u>X</u><cfelse>_</cfif>_ Yes&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(GetAFRRptPg1.TIF_District) is "N"><u>X</u><cfelse>_</cfif>_ No
<br>
<!---
<center>2<br>
