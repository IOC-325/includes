...
<!--- Added per SR13016 --->
<h6 class="clearfix"><a href="#PercAmt">View Percentages for Assets/Liabilities/Net Assets</a>
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2014/MPFReportTot/AFRMPPgF1b.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Multi-Purpose Form&Page=F1b" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<div class="table-responsive">
    <table class="table table-bordered">
		...
		<cfelseif #Category1# is "149t"><cfset TotNetAsstGASB34=TotNetAsstGASB34 +#TotAmount#>
			...
			<tr><td valign="top"><b>146t</b></td><td valign="top"><b><cfif url.PrintIt is "No"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>TOTAL NET ASSETS<cfif url.PrintIt is "No"></a></cfif></b></td>
			<td align="right">#NumberFormat(TotNetAsstGASB34)#</td>
			</tr>
			<tr><cfset TotLiabNetAsstGASB34=#iif(TotLiabGASB34 is "",0,TotLiabGASB34)# + #iif(TotNetAsstGASB34 is "",0,TotNetAsstGASB34)#><td valign="top"><b>147t</b></td><td valign="top"><b><cfif url.PrintIt is "No"><a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No" target="_New"></cfif>TOTAL LIABILITIES & NET ASSETS<cfif url.PrintIt is "No"></a></cfif></b></td>
        ...
        <!--- Added per SR13016 --->
         ...
         <div class="table-responsive">
         <table class="table table-bordered">
        <tr><td>Assets</td><td>Percentages</td></tr>
        ...
        <tr><td>Liabilities</td><td>Percentages</td></tr>
        <cfoutput query="GetLiabilitiesGASB34PerctRpt">
		<tr><td align="left">#AssetDescription#</td><td align="right">#NumberFormat(TotPerctSpent,"999.99")#%</td></tr>
		</cfoutput>
        <tr><td>Net Assets</td><td>Percentages</td></tr>
