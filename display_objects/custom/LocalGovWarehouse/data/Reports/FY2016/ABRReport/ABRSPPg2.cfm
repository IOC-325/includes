...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2016/ABRReport/ABRSPPg2.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=2" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<cfoutput query="GetAFRRptPg1">
<b>B. Does the government have <u>Bonded</u> debt this reporting fiscal year?</b> _<cfif UCase(BondedDebt) is "Y"><u>X</u><cfelse>_</cfif>_ Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(BondedDebt) is "N"><u>X</u><cfelse>_</cfif>_ No<br><br>
...
<cfoutput query="GetAFRRptPg1">
<b>C. Does the government have debt, other than bonded debt this reporting fiscal year?</b> _<cfif UCase(Debt) is "Y"><u>X</u><cfelse>_</cfif>_ Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(Debt) is "N"><u>X</u><cfelse>_</cfif>_ No<br><br>
<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If "Yes", indicate the type(s) of debt <u>and</u> complete the Statement of Indebtedness page, located on page F7.</b><br>
<table class="table table-bordered">
