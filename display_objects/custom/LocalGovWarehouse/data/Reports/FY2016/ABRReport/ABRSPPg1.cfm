...
<h5 class="clearfix">
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2016/ABRReport/ABRSPPg1.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=1" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<table class="table table-bordered">
     <cfoutput query="GetAFRRptPg1">
             <tr>
                 <td colspan="2" valign="top" align="top">A. <b>Contact Person</b> (elected
                     or appointed official responsible for filling out this form)</td>
                 <td colspan="2" valign="top" align="top">B. <b>Chief Executive Officer</b>
                     (Enter your name here ONLY if you are the elected or appointed official <u>responsible</u> for the
                     EXECUTIVE ADMINISTRATION, i.e. mayor, supervisor, or chairman. Your name will be listed with this
                     responsibility on our website.)</td>
                 <td colspan="2" valign="top" align="top">C. <b>Chief Financial Officer</b>
                     (Enter your name here ONLY if you are the elected or appointed official <u>responsible</u> for
                     MAINTAINING THE GOVERNMENT'S FINANCIAL RECORDS. Your name will be listed with this responsibility
                     on our website.)</td>
                 <td colspan="2" valign="top" align="top">D. <b>Purchasing Agent</b> (Enter
                     the Purchasing Agent or if there is no Purchasing Agent, the name of the person responsible for
                     oversight of all competitively bid contracts should be listed)</td>
             </tr>
         <tr>
         <td>#FirstName#</td>
     <td>#LastName#</td>
...
<!---
	...
	<div class="text-center"> <b>Local Government Warehouse Copy</b></div>
