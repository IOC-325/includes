...
<cfinclude template="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/Data/Reports/AvailableAFR.cfm">
     ...
     <cfoutput>
         <cfif url.PrintIt is "no">
             <a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2016/RegOnlyReport/RegOnlyPg1.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Registration Form&Page=1"
                 class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
             Print This Page</a></span></cfif></cfoutput>
     </h3>
     Please be sure to fill out this section accurately. The information you provide below is (1) our
         primary way of contacting your government, (2) the information we supply to external agencies, and (3) is the
         name and title we will list on our website. This section should NOT contain ANY of your Accounting
     ...
     <td width="40">
         ...
         <td colspan="6">If the Chief Executive Officer and the Chief Financial Officer are the same
             person as the Contact Person, please check this box and skip to Step 2. If not, please <u>do not</u> leave
             columns B and C blank.</td></tr>
     </cfoutput>
     </table>
