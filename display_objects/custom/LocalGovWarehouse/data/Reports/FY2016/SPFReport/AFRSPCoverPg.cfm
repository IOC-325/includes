...
<cfparam name="url.PrintIt" default="No">
 ...
 <tr>
 <td VALIGN="TOP">FY
     <cfoutput>#url.CFY#</cfoutput>
         <br>Annual Financial Report<br>Special Purpose Long Form
     </td>
     ...
     <cfoutput>
         <cfif url.PrintIt is "no">
             <a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2016/SPFReport/AFRSPCoverPg.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=1"
     ...
     <cfoutput query="GetAFRRptPg1">
             I attest that, to the best of my knowledge, this report represents a complete and
                 accurate statement of the financial position of #UnitName# #Description#
                 as of the end of this fiscal year.<br><br><br>
                 <hr color="black"><br>
