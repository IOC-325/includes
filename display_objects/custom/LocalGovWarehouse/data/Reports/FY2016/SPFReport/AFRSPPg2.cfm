...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2016/SPFReport/AFRSPPg2.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=2" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<tr><td>_<cfif AccountingMethod is "Cash"><u>X</u><cfelse>_</cfif>_ Cash - with no assets (Cash Basis)</td><td>_<cfif AccountingMethod is "Modified Accrual"><u>X</u><cfelse>_</cfif>_ Modified Accrual</td></tr>
...
<cfoutput query="GetAFRRptPg1">
<b>D. Does the government have debt, other than bonded debt this reporting fiscal year?</b> _<cfif UCase(Debt) is "Y"><u>X</u><cfelse>_</cfif>_ Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_<cfif UCase(Debt) is "N"><u>X</u><cfelse>_</cfif>_ No<br><br>
<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If "Yes", indicate the type(s) of debt <u>and</u> complete the Statement of Indebtedness page, located on page F7.</b><br>
<table class="table table-bordered">
