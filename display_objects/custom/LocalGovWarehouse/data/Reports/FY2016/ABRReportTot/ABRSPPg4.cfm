...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2016/ABRReportTot/ABRSPPg4.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Abbreviated Form&Page=4" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<table class="table table-bordered">
    <cfoutput query="GetAFRRptPg1">
        <tr>
        <td align="left"><cfif url.PrintIt is "no">
        <a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No"
            target="_New"></cfif>
            Intergovernmental agreements - indicate how much was paid<cfif url.PrintIt is "no"></a></cfif></td>
    <td align="right">#NumberFormat(AmtState, "$9,999,999,999,999,999")#</td></tr>
    <tr>
    <td align="left"><cfif url.PrintIt is "no">
        <a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No"
            target="_New"></cfif>Federal government payroll taxes<cfif url.PrintIt is "no"></a></cfif></td>
    <td align="right">#NumberFormat(AmtFederal, "$9,999,999,999,999,999")#</td></tr>
    <tr>
    <td align="left"><cfif url.PrintIt is "no">
        <a href="/financial-data/local-government-division/local-government-data/processsearchresults/?DisplayMode=GetAFR&AFRDesiredData=#url.AFRDesiredData#&Code=#url.Code#&CFY=#url.CFY#&Menu=No"
            target="_New"></cfif>All other intergovernmental payments<cfif url.PrintIt is "no"></a></cfif></td>
