...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2017/SPFReportTot/AFRSPPgF1.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData# Summary&Format=Special Purpose Form&Page=F1" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<table class="table table-bordered">
    <tr>
        <td colspan="3" align="center" valign="top"><b>Statement of Financial Position</b></td>
    </tr>
    <tr>
        <td colspan="3" align="center" valign="top"><b>All Funds and Discretely Presented Component Units</b></td>
    </tr>
    <tr>
