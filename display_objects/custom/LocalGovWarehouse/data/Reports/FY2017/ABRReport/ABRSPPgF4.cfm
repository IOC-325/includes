...
<cfinclude template="#application.configbean.getContext()#/#application.settingsmanager.getSite(request.siteid).getDisplayPoolID()#/includes/display_objects/custom/LocalGovWarehouse/Data/Reports/AvailableAFR.cfm">
    ...
    <cfoutput><cfif url.PrintIt is "no">
            <span class="pull-right">
                    <a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2017/ABRReport/ABRSPPgF4.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Abbreviated Form&Page=F4"
    ...
    <tr>
        <td colspan="13" valign="top" align="center">Report in Whole Numbers</td>
    </tr>
    <cfoutput>
            <tr>
                <td><b>Total Debt</b></td>
                    <td><b>405</b></td>
        <td align="right">#NumberFormat(iif(t405 is not "", NumberFormat(t405, "999999999999999"), 0))#
                </td>
                    <td><b>411</b></td>
        <td align="right">#NumberFormat(iif(t411 is not "", NumberFormat(t411, "999999999999999"), 0))#
                </td>
                    <td><b>417</b></td>
        <td align="right">#NumberFormat(iif(t417 is not "", NumberFormat(t417, "999999999999999"), 0))#
                </td>
                    <td><b>423</b></td>
        <td align="right">#NumberFormat((iif(t405 is not "", NumberFormat(t405, "999999999999999"), 0) + iif(t411 is not "", NumberFormat(t411, "999999999999999"), 0) - iif(t417 is not "", NumberFormat(t417, "999999999999999"), 0)))#
                </td>
            <td align="right">#iif(t429 is not "", NumberFormat(t429, "999999999999999"), NumberFormat(0, "999999999999999"))#
                </td>
            <td align="right">#DateFormat(t435, "MM/DD/YYYY")#</td>
        <td align="right">#iif(t441 is not "", NumberFormat(t441, "999999999999.99"), NumberFormat(0.00, "999999999999.99"))#
                </td>
            <td align="right">#iif(t447 is not "", NumberFormat(t447, "999999999999.99"), NumberFormat(0.00, "999999999999.99"))#
                </td>
            </tr>
    </cfoutput>
    </table>
