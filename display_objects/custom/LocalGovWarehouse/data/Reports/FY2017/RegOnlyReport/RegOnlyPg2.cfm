...
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2017/RegOnlyReport/RegOnlyPg2.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Registration Form&Page=2" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
...
<b>P1. Has your government commenced dissolution proceedings?</b>&nbsp;&nbsp;&nbsp;&nbsp;<u>&nbsp;</u>
    <cfif UCase(GetAFRRptPg1.DissolutionProceeding) is "Y"><u>X</u>
        <cfelse><u>&nbsp;</u></cfif><u>&nbsp;</u> Yes&nbsp;&nbsp;&nbsp;&nbsp;<u>&nbsp;</u>
    <cfif UCase(GetAFRRptPg1.DissolutionProceeding) is "N"><u>X</u>
        <cfelse><u>&nbsp;</u></cfif><u>&nbsp;</u> No&nbsp;&nbsp;&nbsp;&nbsp;
<b>Dissolution Filing Date:</b>
    <cfif trim(GetAFRRptPg1.DissolutionPrelimDate) is not "">
        <u><cfoutput>#DateFormat(GetAFRRptPg1.DissolutionPrelimDate, "mm/dd/yyyy")#</cfoutput></u><cfelse>
        <u> </u></cfif><br>
...
<table class="table table-bordered">
    <cfoutput query="GetAFRRptPg1">
        <tr>
        <td>^What is the total <b>population served or school enrollment</b> of #UnitName# #Description#?</td>
    ...
    <h5>
        <span class="glyphicon glyphicon-circle-arrow-right"></span> STEPS 4 AND 5: COMPONENT UNITS AND APPROPRIATIONS
    </h5>
    <b>Provide the appropriation for the primary government listed in the first row of the table below.</b><br>

    If you are a primary unit of government, provide your Unit name and appropriation in the first row of the table below and list any component unit(s):
    <br>
...
*Do not enter funds such as: Joint Bridge, Permanent Road, Town Fund, Equipment, Water & Sewer, General Assistance, etc.<br>^If the Primary Government or Component Unit does NOT budget or levy taxes, please enter the unit's TOTAL EXPENDITURES.
</div>
