...
<h3 class="clearfix">
<span class="pull-right"><cfoutput><cfif url.PrintIt is "no"><a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2017/SPFReport/AFRSPPgF4.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=F4" class="btn btn-primary nomargin"><span class="glyphicon glyphicon-print"></span>
     Print This Page</a></span></cfif></cfoutput>
</h3>

<div class="table-responsive">
<table class="table table-bordered">
    <tr><td colspan="10" align="center"><b>Fund Balances and Other Financing Sources (Uses)</b></td></tr>
...
Special Purpose Form</center>  --->
    ...
    <cfif url.Menu is "Yes" and url.PrintIt is "no">
   	...
   	<cfif url.PrintIt is "No">
        ...
        <td>#url.CFY# Special Purpose Form - F4</td>
         </tr>
        </table>
         </div>
         </cfoutput>
