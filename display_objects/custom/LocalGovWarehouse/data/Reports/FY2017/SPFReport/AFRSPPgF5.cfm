...
<span class="pull-right"> 
	<a href="/financial-data/local-government-division/local-government-data/pdfreport/?FileName=/data/reports/FY2017/SPFReport/AFRSPPgF5.cfm&Code=#url.Code#&CFY=#url.CFY#&PrintIt=Yes&AFRDesiredData=#url.AFRDesiredData#&Format=Special Purpose Form&Page=F5" class="btn btn-primary nomargin">
...
<table class="table table-bordered">
    <tr><td colspan="13" align="center"><b>Statement of Indebtedness (Governmental and Propriety)</b></td></tr>
		...
		<tr><td colspan="13" valign="top">Report in Whole Numbers</td></tr>		
		<cfoutput>
			<tr>
            ...
            <td align="right"><cfif a424 is not "">#NumberFormat(a424,"9999999999999999")#<cfelseif b424 is not "">#NumberFormat(b424,"9999999999999999")#<cfelseif c424 is not "">#NumberFormat(c424,"9999999999999999")#<cfelseif d424 is not "">#NumberFormat(d424,"9999999999999999")#<cfelseif e424 is not "">#NumberFormat(e424,"9999999999999999")#</cfif></td>
            <td align="right"><cfif a430 is not "">#DateFormat(a430,"MM/DD/YYYY")#<cfelseif b430 is not "">#DateFormat(b430,"MM/DD/YYYY")#<cfelseif c430 is not "">#DateFormat(c430,"MM/DD/YYYY")#<cfelseif d430 is not "">#DateFormat(d430,"MM/DD/YYYY")#<cfelseif e430 is not "">#DateFormat(e430,"MM/DD/YYYY")#</cfif></td>
            <td align="right"><cfif a436 is not "">#NumberFormat(a436,"9999999999999.99")#<cfelseif b436 is not "">#NumberFormat(b436,"9999999999999.99")#<cfelseif c436 is not "">#NumberFormat(c436,"9999999999999.99")#<cfelseif d436 is not "">#NumberFormat(d436,"9999999999999.99")#<cfelseif e436 is not "">#NumberFormat(e436,"9999999999999.99")#</cfif></td>
            <td align="right"><cfif a442 is not "">#NumberFormat(a442,"9999999999999.99")#<cfelseif b442 is not "">#NumberFormat(b442,"9999999999999.99")#<cfelseif c442 is not "">#NumberFormat(c442,"9999999999999.99")#<cfelseif d442 is not "">#NumberFormat(d442,"9999999999999.99")#<cfelseif e442 is not "">#NumberFormat(e442,"9999999999999.99")#</cfif></td>
			</tr>
			<tr>
            ...
            <td align="right"><cfif a425 is not "">#NumberFormat(a425,"9999999999999999")#<cfelseif b425 is not "">#NumberFormat(b425,"9999999999999999")#<cfelseif c425 is not "">#NumberFormat(c425,"9999999999999999")#<cfelseif d425 is not "">#NumberFormat(d425,"9999999999999999")#<cfelseif e425 is not "">#NumberFormat(e425,"9999999999999999")#</cfif></td>
            <td align="right"><cfif a431 is not "">#DateFormat(a431,"MM/DD/YYYY")#<cfelseif b431 is not "">#DateFormat(b431,"MM/DD/YYYY")#<cfelseif c431 is not "">#DateFormat(c431,"MM/DD/YYYY")#<cfelseif d431 is not "">#DateFormat(d431,"MM/DD/YYYY")#<cfelseif e431 is not "">#DateFormat(e431,"MM/DD/YYYY")#</cfif></td>
            <td align="right"><cfif a437 is not "">#NumberFormat(a437,"9999999999999.99")#<cfelseif b437 is not "">#NumberFormat(b437,"9999999999999.99")#<cfelseif c437 is not "">#NumberFormat(c437,"9999999999999.99")#<cfelseif d437 is not "">#NumberFormat(d437,"9999999999999.99")#<cfelseif e437 is not "">#NumberFormat(e437,"9999999999999.99")#</cfif></td>
            <td align="right"><cfif a443 is not "">#NumberFormat(a443,"9999999999999.99")#<cfelseif b443 is not "">#NumberFormat(b443,"9999999999999.99")#<cfelseif c443 is not "">#NumberFormat(c443,"9999999999999.99")#<cfelseif d443 is not "">#NumberFormat(d443,"9999999999999.99")#<cfelseif e443 is not "">#NumberFormat(e443,"9999999999999.99")#</cfif></td>
			</tr>
			<tr>
	...
	<cfif url.PrintIt is "No">
        ...
        <td>#url.CFY# Special Purpose Form - F5</td>
         </tr>
        </table>
         </div>
         </cfoutput>
