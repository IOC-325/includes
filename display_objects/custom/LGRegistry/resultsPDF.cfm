...
PDF output for results from the Search Results page --->
...
<font size="+3"><center>Contact Information</center></font>

<p>Your search for
<CFPARAM NAME="lstUnitName" DEFAULT="">
...
unit name<cfif totCount.recordCount GT 1>s</cfif> 
<!--- <cfoutput query="getList" group="UnitName"><cfset UnitName2 = ListAppend(UnitName, "")>
 <em><strong>#UnitName2#</strong></em></cfoutput> ---> resulted in 
<cfoutput query="getList" maxrows="1"><strong>#getList.RecordCount#</strong></cfoutput> Contact Information results.</p>
