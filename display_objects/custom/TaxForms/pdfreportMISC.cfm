<cfdocument format="PDF" marginbottom="0.5" marginleft="0.4" margintop="0.4" marginright="0.4" orientation="portrait" pagetype="LETTER" fontembed="No" scale="50">
...
<cfoutput>#session.MISCTaxReportData#</cfoutput>
</cfdocument>