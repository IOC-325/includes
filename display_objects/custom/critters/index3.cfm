...
<div class="col-xs-12"><a href="/services/critters/animal-shelters/" style="text-decoration:underline; color:blue;" align="center"><h3 align="center">View All Shelters</a></h3>


<!--- Adding row for different types of searches --->
<div class="row">
    ...
    <form name="shelter-search" action="" method="post" id="shelter-search">
      <div class="inline-form">
        <div class="form-group">
          ...
          <select name="county" id="county" class="form-control form-input col-xs-12 col-sm-9">
            <option value="" <cfif $.event('distance') eq 5>selected</cfif>>Sangamon</option>
          </select>
          <p>
