<cfoutput>
 ...
 <!--- RK's Custom CSS for fotter menu links --->
 <link rel="stylesheet" href="#$.siteConfig('themeAssetPath')#/assets/bootstrap/css/style.css">
 <!--- RK's Custom Js for fotter menu links --->
<script src="#$.siteConfig('themeAssetPath')#/assets/bootstrap/js/formatFooterLinks.js"></script>
</cfoutput>