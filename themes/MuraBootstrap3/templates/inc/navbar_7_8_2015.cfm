<cfoutput>
	...
	<div class="nav-header">
		...
		<div class="hidden-xs col-sm-3 pull-right apps">
			<a href="">
				<img src="/comptroller/assets/image/app-store.png"
				title="Download our app on the App Store"
				alt="Download our app on the App Store"
				align="right"
				class="app-image" />
			</a>
			<a href="https://play.google.com/store/apps/details?id=com.planetbomba">
				<img src="/comptroller/assets/image/google-play.png"
