						...
						<div class="col-sm-10 col-sm-offset-1">
							...
							<div class="obligation">
								...
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="col-sm-12">
											<p>This table shows the most recent bond ratings from three credit rating bureaus for the two major State of Illinois bond programs.</p>
										</div>
									</div>
