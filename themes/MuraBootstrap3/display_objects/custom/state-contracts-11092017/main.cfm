...
<cfparam name="FY" default="20#application.cfy#">
...
<cfelse>
  <!--- Get Most Previous Fiscal Year that has stats --->
    <cfset FY="20#application.PopularQueryFY#">
...
<cfoutput>
  ...
  <div id="payment" class="contract">
                      ...
                      <div class="col-sm-9">
                        <select  id="contractAgency" name="contractAgency">
                          ...
                          <cfloop query = "qAN">
                            ...
                            <cfif variables.AgencyName eq qAN.AgencyName> selected</cfif>>#qAN.AgencyName#</option>
                          </cfloop>
                        </select>
                      </div>
                      <div class="col-sm-4">
   ...
   <cfif isDefined("GetContractInfo") && GetContractInfo.recordcount GT 5000>
      ...
      <div class="row">
        <div class="col-sm-10 col-sm-offset-1">
           ...
           <div class="alert alert-info small">
             <span class="small">CSV download is unavailable for a search result greater than 5,000 records.
              <cftry>
                 <cffile action = "read" variable="TestAgency" file = "\\ioc-webvm-cf1.iocweb.net\Downloads$\#ExportFile#">
          ...
          <cfelse>
            ...
            <thead>
              <tr>
                ...
                <th class="sum bg-info"><a href="?PageIndex=1&contractFY=#variables.FY#&contractAgency=#variables.AgencyName#&contractClass=#variables.ClassDescription#&contractType=#variables.TypeDescription#&contractAward=#variables.AwardDescription#&FindVendor=#variables.FindVendor#&ContractVendor=#variables.ContractVendor#&SortColumn=12&SortDirection=#variables.SortDirection#&header=true" data-toggle="tooltip" title="" data-original-title="The figure displayed on this page represents the gross amount of vouchers submitted to the Comptroller. The breakdown of payments shows only those that have been released to the vendor.">Current<br>Expended<br>Amount</a><br></th>
              </tr>
            </thead>
            <tbody id="content">
    ...
    <!--- <div class="col-sm-12">
     <h2><p class="text-center">Download files</p></h2>
    <div> --->
         ...
         $.ajax({
            ...
            success: function (data) {
             ...
             if(data.length >=1){
              ...
              trHTML = '<div align="center">No Payments Issued</div>';
             }
