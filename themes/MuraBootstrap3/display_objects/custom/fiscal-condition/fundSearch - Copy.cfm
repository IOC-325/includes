            ...
            <div class="col-sm-11 col-sm-offset-1">
              <div class="detail text-left">
               ...
               <div class="amount_type">End Daily Amount:</div>
                 ...
                 <p class="well well-lg" style="background-color:##376C8C; color:##fff; margin-top:20px; font-style:italic; border-color:##2CABE1;"><span style="color:##2CABE1;">*</span>
                    Reflects operating revenue used to address obligations and bill backlogs. At times, balances may rise in order to meet these pending obligations, such as General State Aid, Medical, Human Services, Payrolls, Pensions, etc.</p>
                </div>
               </cfif>
              </div>
            </div>
