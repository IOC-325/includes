  ...
  <div class="explosive">
   <div class="col-sm-10 col-sm-offset-1 text-left">
      <CFIF NOT Results.recordcount>
        <p align="center">No Results Found<!--- <img src="../images/NoResultsFound.png" /> ---> 
        <div class="btn-align text-center">
     <button class="btn btn-default" name="GetFundDetails" value="Learn More About This Fund">Learn More About This Fund</button>
    </div></p>
      <cfelse>
           ...
           <div class="row">
            <div class="col-sm-11 col-sm-offset-1">
              <div class="detail text-left">
               ...
               <div class="amount">#DollarFormat(BEGIN_DAILY_AMT)#<div class="mytooltip"><i class="fa fa-info-circle info-formatting"></i><span class="mytooltiptext">The amount of cash in the fund at the beginning of the business day.</span></div></div>
               <div class="amount_type">Receipt Amount:</div>
               <div class="amount">#DollarFormat(RECEIPT_AMT)#<div class="mytooltip"><i class="fa fa-info-circle info-formatting"></i><span class="mytooltiptext">The amount of deposits into the fund for the business day from various taxes and fees.</span></div></div>
               <div class="amount_type">Transfers In:</div>
               <div class="amount">#DollarFormat(TRANS_IN_AMT)#<div class="mytooltip"><i class="fa fa-info-circle info-formatting"></i><span class="mytooltiptext">The amount of monies transferred into the fund from other state funds for the business day.</span></div></div>
               <div class="amount_type">Transfers Out:</div>
               <div class="amount">#DollarFormat(trans_out_amt)#<div class="mytooltip"><i class="fa fa-info-circle info-formatting"></i><span class="mytooltiptext">The amount of monies transferred out of the fund to other state funds for the business day.</span></div></div>
               <div class="amount_type">Net Warrants Issued:</div>
               <div class="amount">#DollarFormat(NET_WARR_ISSUED)#<div class="mytooltip"><i class="fa fa-info-circle info-formatting" style=""></i><span class="mytooltiptext">The amount of vouchers released from the fund for the business day.</span></div></div>
               <cfif results.FUND neq "0001">
               <div class="amount_type">End Daily Amount:</div>
               <div class="amount">#DollarFormat(END_DAILY_AMT)#</div>
               <cfelse>
                <div class="amount_type">End Daily Amount:</div>
                 <div class="amount" style="color:##376C8C;">#DollarFormat(END_DAILY_AMT)#<span style="color:##2CABE1;">*</span></div>
                 <p class="well well-lg" style="background-color:##376C8C; color:##fff; margin-top:20px; font-style:italic; border-color:##2CABE1;"><span style="color:##2CABE1;">*</span>  Reflects operating revenue used to address obligations and bill backlogs. At times, balances may rise in order to meet pending obligations, such as General State Aid, Medical, Human Services, Payrolls, Pensions, Debt Service, etc.</p>
                </div>
               </cfif>
              </div>
            </div>
