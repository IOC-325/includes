...
<!--- Handle Inline report link submit --->
    ...
    <cfif IsDefined("form.ApprCatSel") AND TRIM(form.ApprCatSel) IS NOT "" AND form.ApprCatSel IS NOT 0 AND form.ApprCatSel IS NOT "Default" AND TRIM(form.ApprCatSel) IS NOT "Default">
...
<!--- Obje --->
    ...
    <cfif IsDefined("form.ObjtCatSel") AND TRIM(form.ObjtCatSel) IS NOT "" AND form.ObjtCatSel IS NOT 0 AND form.ObjtCatSel IS NOT "Default" AND TRIM(form.ObjtCatSel) IS NOT "Default">
...
<!--- Get Expenditures --->
        <cfinvoke component="Queries.warehouse"
                method="GetObjectOfExpenditures"
                returnvariable="ObjeList">
                <cfinvokeargument name="SortName" value="No">
        </cfinvoke>
<!--- Get Appropriation Group --->
        <cfinvoke component="Queries.warehouse"
                method="GetAppropriationGroup"
                returnvariable="ApprGrpList">
        </cfinvoke>
<!--- Get Category List --->
        <cfinvoke component="Queries.warehouse"
                method="GetCategoryList"
                returnvariable="ApprCatList">
        </cfinvoke>
<!--- Get Type List --->
        <cfinvoke component="Queries.warehouse"
                method="GetTypeList"
                returnvariable="ApprTypList">
        </cfinvoke>
<!--- Get Class List --->
        <cfinvoke component="Queries.warehouse"
                method="GetClassList"
...
<!--- Get Fiscal years --->
    ...
    <CFIF IsDefined("cookie.ExpenseByObjectExpenditure") AND ListLen(cookie.ExpenseByObjectExpenditure) IS 32>
<!--- Get the clients cookie values and set them as variables  --->
        <CFSET C1_GroupBy = ListGetAt(cookie.ExpenseByObjectExpenditure, 1)>
        <CFSET C1_FY = ListGetAt(cookie.ExpenseByObjectExpenditure, 2)>
        <CFSET C1_Type = ListGetAt(cookie.ExpenseByObjectExpenditure, 3)>
        <CFSET C1_ShowMo = ListGetAt(cookie.ExpenseByObjectExpenditure, 4)>
        <CFSET C1_Budget = ListGetAt(cookie.ExpenseByObjectExpenditure, 5)>
        <CFSET C1_Lapse = ListGetAt(cookie.ExpenseByObjectExpenditure, 6)>
        <CFSET C1_AgcyCatSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 7)>
        <CFSET C1_AgcySel = ListGetAt(cookie.ExpenseByObjectExpenditure, 8)>
        <CFSET C1_AgcyGrpSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 9)>
        <CFSET C1_AgcyTypeSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 10)>
        <CFSET C1_FundCatSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 11)>
        <CFSET C1_FundSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 12)>
        <CFSET C1_FundGrpSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 13)>
        <CFSET C1_FundTypeSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 14)>
        <CFSET C1_RevCatSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 15)>
        <CFSET C1_RevSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 16)>
        <CFSET C1_RevGrpSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 17)>
        <CFSET C1_RevTypeSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 18)>
        <CFSET C1_ObjeCatSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 19)>
        <CFSET C1_ObjeSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 20)>
        <CFSET C1_ObjeGrpSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 21)>
        <CFSET C1_ObjeTypeSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 22)>
        <CFSET C1_ObjtSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 23)>
        <CFSET C1_ObjtGrpSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 24)>
        <CFSET C1_ObjtCatSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 25)>
        <CFSET C1_ObjtTypeSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 26)>
        <CFSET C1_ObjtClsSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 27)>
        <CFSET C1_ApprSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 28)>
        <CFSET C1_ApprGrpSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 29)>
        <CFSET C1_ApprCatSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 30)>
        <CFSET C1_ApprTypeSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 31)>
        <CFSET C1_ApprClsSel = ListGetAt(cookie.ExpenseByObjectExpenditure, 32)>
<!--- Get Friend Names from the cookie values. --->
            <cfinvoke component="Queries.expenditures"
                    method="GetFreindlyName_Expense_ByObjectExpenditure"
                    returnvariable="FN1">
            </cfinvoke>
...
<div class="col-md-10 col-md-offset-1">
    <CFIF NOT IsDefined("results")>
            <p>Object of Expenditure is a department classification used by the State to group expenses.</p>
        <cfelseif IsDefined("cookie.ExpenseByObjectExpenditure") AND ListLen(cookie.ExpenseByObjectExpenditure) IS 32>
...
<!--- Display Adobe PDF Download for results --->
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-5 col-sm-offset-0 col-md-5 col-md-offset-1 label-div">
            <div class="btn-label">Object of Expenditure</div>
        </div>

    <div class="col-xs-12 col-sm-7 col-md-5">
    <SELECT NAME="ObjeSel" class="select2">
        <OPTION VALUE="">Object of Expenditure</option>
        <cfloop query="ObjeList">
            <CFIF ObjeSel is ObjeList.Obj_Exp>
                    <OPTION VALUE="#Obj_Exp#" SELECTED>#Obj_Exp# - #Name#</option>
            <CFELSE>
                    <OPTION VALUE="#Obj_Exp#">#Obj_Exp# - #Name#</option>
            </CFIF>
        </cfloop>
        </SELECT>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-5 col-sm-offset-0 col-md-5 col-md-offset-1 label-div">
                <div class="btn-label">Appropriation Group</div>
            </div>

        <div class="col-xs-12 col-sm-7 col-md-5">
        <SELECT NAME="ApprGrpSel" class="select2">
            <OPTION VALUE="">Appropriation Group</option>
        <cfloop query="ApprGrpList">
            <CFIF ApprGrpSel is ApprGrpList.Group>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-5 col-sm-offset-0 col-md-5 col-md-offset-1 label-div">
                <div class="btn-label">Appropriation Category</div>
            </div>

        <div class="col-xs-12 col-sm-7 col-md-5">
        <SELECT NAME="ApprCatSel" class="select2">
            <OPTION VALUE="">Appropriation Category</option>
        <cfloop query="ApprCatList">
            <CFIF ApprCatSel is ApprCatList.Category>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-5 col-sm-offset-0 col-md-5 col-md-offset-1 label-div">
                <div class="btn-label">Appropriation Type</div>
            </div>

        <div class="col-xs-12 col-sm-7 col-md-5">
        <SELECT NAME="ApprTypeSel" class="select2">
            <OPTION VALUE="">Appropriation Type</option>
        <cfloop query="ApprTypList">
            <CFIF ApprTypeSel is ApprTypList.Type>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-5 col-sm-offset-0 col-md-5 col-md-offset-1 label-div">
                <div class="btn-label">Appropriation Class</div>
            </div>

        <div class="col-xs-12 col-sm-7 col-md-5">
        <SELECT NAME="ApprClsSel" class="select2">
        ...
        <cfselect name="GroupBy" class="select2">
                ...
                <OPTION VALUE="Objt" SELECTED>Group by Object</option>
...
<!--- ******************************************************************************************** --->
            <CFIF IsDefined("form.PrintAsPDF")>
                <cfsaveContent variable="returnString">
                    <cfinclude template="outputs/ByObjectExpenditure1.cfm">
                </cfsaveContent>
...
<!--- 	<img alt="" src="#$.siteconfig('themeassetpath')#/images/CW_AlertIcon.jpg" /> --->
    ...
    <CFIF Not IsDefined("results") AND IsDefined("cookie.ExpenseByObjectExpenditure") AND ListLen(cookie.ExpenseByObjectExpenditure) IS 32>
