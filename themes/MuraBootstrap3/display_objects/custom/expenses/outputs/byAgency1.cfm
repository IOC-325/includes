            ...
            <thead>
                ...
                <tr>
                    ...
                    <CFIF variables.ShowBudg is "Yes" AND IsDefined ("Results.ApprTotal")>
                        <th class="sum header-center">Appropriated</th>
                    </CFIF>
                    <th class="sum header-center" nowrap="nowrap">Expended YTD</th>
                    <CFIF variables.ShowMo is "Yes">
