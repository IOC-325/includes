    ...
    <table class="#tableClass# table-striped datatable-primary" style="width: 100%;">
        <thead>
            ...
            <tr>
                ...
                <th class="super-header"></th>
                <cfif variables.showBudg eq "yes">
                    <th class="super-header">&nbsp;</th>
                </cfif>
                <th class="super-header">&nbsp;</th>
                ...
                <cfif variables.showBudg eq "yes" OR variables.ShowLapse IS "Yes">
            ...
            <tr>
                ...
                <CFIF variables.ShowBudg is "Yes">
                    <th class="sum header-right">Appropriated</th>
                </CFIF>
                <th class="sum" align="right"  nowrap="nowrap">Expended YTD</th>
                <CFIF variables.ShowMo is "Yes">
        ...
        <tbody>
            ...
            <tr>
                <td><a href="?GroupBy=#OutGoingGroupBy#&FY=#variables.FY#&ShowMo=#variables.ShowMo#&ShowBudg=#variables.ShowBudg#&ShowLapse=#variables.ShowLapse#&FundSel=#variables.FundSel#&FundGrpSel=#variables.FundGrpSel#&AgcySel=#variables.AgcySel#&AgcyGrpSel=#variables.AgcyGrpSel#&AgcyTypeSel=#variables.AgcyTypeSel#&AgcyCatSel=#variables.AgcyCatSel#&RevSel=#variables.RevSel#&RevClsSel=#variables.RevClsSel#&RevGrpSel=#variables.RevGrpSel#&RevTypeSel=#variables.RevTypeSel#&Type=#variables.Type#" target="_top">#Code#</a></td>
                <td><a href="?GroupBy=#OutGoingGroupBy#&FY=#variables.FY#&ShowMo=#variables.ShowMo#&ShowBudg=#variables.ShowBudg#&ShowLapse=#variables.ShowLapse#&FundSel=#variables.FundSel#&FundGrpSel=#variables.FundGrpSel#&AgcySel=#variables.AgcySel#&AgcyGrpSel=#variables.AgcyGrpSel#&AgcyTypeSel=#variables.AgcyTypeSel#&AgcyCatSel=#variables.AgcyCatSel#&RevSel=#variables.RevSel#&RevClsSel=#variables.RevClsSel#&RevGrpSel=#variables.RevGrpSel#&RevTypeSel=#variables.RevTypeSel#&Type=#variables.Type#" target="_top">#Name#</a></td>
                <CFIF variables.ShowBudg is "Yes">
