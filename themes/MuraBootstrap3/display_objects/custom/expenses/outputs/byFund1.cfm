...
$(document).ready(function(){
 ...
 <a class="pop" data-toggle="popover" data-placement="right"
                    data-content="This amount represents expenditures for September Lapse Period and any succeeding Lapse Period months.  
                                        You can obtain information for the individual months by contacting our Office 
                                        <a href=&quot;https://illinoiscomptroller.gov/about/contact/send-us-a-message/&quot;>here</a>.">Sep and more</a>--->
    ...
    <table class="#tableClass# table-striped datatable-primary" style="width: 100%">
        <thead>
            ...
            <tr>
                ...
                <CFIF variables.ShowMo is "Yes" AND variables.ShowLapse is "Yes">
                    <th class="sum header-center">Jul</th>
                    <th class="sum header-center">Aug</th>
                    <!---<th class="sum header-center"> 
                    <a class="pop" data-toggle="popover" data-placement="right"
                    data-content="This amount represents expenditures for September Lapse Period and any succeeding Lapse Period months.  
                                        You can obtain information for the individual months by contacting our Office 
                                        <a href=&quot;https://illinoiscomptroller.gov/about/contact/send-us-a-message/&quot;>here</a>.">Sep and more</a></th>--->
                    <!---
                    <th class="sum header-center">
                            <a href=" " title="This amount represents expenditures for September Lapse Period and any succeeding Lapse Period months.  
                                        You can obtain information for the individual months by contacting our Office here." style="color:white;text-decoration:none">Sep and more</a></th>--->
        ...
        <cfloop QUERY="Results">
            ...
            <tr>
                ...
                <cfelse>
                    <td><a href="?GroupBy=#OutGoingGroupBy#&FY=#variables.FY#&ShowMo=#variables.ShowMo#&ShowBudg=#variables.ShowBudg#&ShowLapse=#variables.ShowLapse#&FundSel=#variables.FundSel#&FundGrpSel=#variables.FundGrpSel#&FundCatSel=#variables.FundCatSel#&AgcySel=#variables.AgcySel#&AgcyGrpSel=#variables.AgcyGrpSel#&AgcyTypeSel=#variables.AgcyTypeSel#&AgcyCatSel=#variables.AgcyCatSel#&RevSel=#variables.RevSel#&RevClsSel=#variables.RevClsSel#&RevGrpSel=#variables.RevGrpSel#&RevTypeSel=#variables.RevTypeSel#&Type=#variables.Type#&ObjeSel=#variables.ObjeSel#&ObjeGrpSel=#variables.ObjeGrpSel#&ObjeCatSel=#variables.ObjeCatSel#&ObjeTypeSel=#variables.ObjeTypeSel#&ApprSel=#variables.ApprSel#&ApprGrpSel=#variables.ApprGrpSel#&ApprTypeSel=#variables.ApprTypeSel#&ApprCatSel=#variables.ApprCatSel#&ApprClsSel=#variables.ApprClsSel#" target="_top">#Code#</a></td>
                    <td><a href="?GroupBy=#OutGoingGroupBy#&FY=#variables.FY#&ShowMo=#variables.ShowMo#&ShowBudg=#variables.ShowBudg#&ShowLapse=#variables.ShowLapse#&FundSel=#variables.FundSel#&FundGrpSel=#variables.FundGrpSel#&FundCatSel=#variables.FundCatSel#&AgcySel=#variables.AgcySel#&AgcyGrpSel=#variables.AgcyGrpSel#&AgcyTypeSel=#variables.AgcyTypeSel#&AgcyCatSel=#variables.AgcyCatSel#&RevSel=#variables.RevSel#&RevClsSel=#variables.RevClsSel#&RevGrpSel=#variables.RevGrpSel#&RevTypeSel=#variables.RevTypeSel#&Type=#variables.Type#&ObjeSel=#variables.ObjeSel#&ObjeGrpSel=#variables.ObjeGrpSel#&ObjeCatSel=#variables.ObjeCatSel#&ObjeTypeSel=#variables.ObjeTypeSel#&ApprSel=#variables.ApprSel#&ApprGrpSel=#variables.ApprGrpSel#&ApprTypeSel=#variables.ApprTypeSel#&ApprCatSel=#variables.ApprCatSel#&ApprClsSel=#variables.ApprClsSel#" target="_top">#Name#</a></td>
                </cfif>
                <CFIF variables.ShowBudg is "Yes"  AND IsDefined ("Results.ApprTotal")>
