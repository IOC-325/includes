...
<form action="" id="samsMonthlyReports" method="post" name="GetSelectionInfo">
	...
	<div class="row">
		...
		<div class="col-md-5">
      <select id="FY" name="FY" onchange="SetFY();">
	...
	<div class="row">
		...
		<div class="col-md-5">
      <select id="Accounting_Period" name="Accounting_Period" onchange="SetAccountingPeriod();">
	...
	<div class="row">
		...
		<div class="col-md-5">
      <select id="Agency_No" name="Agency_No" onchange="SetAgency();" >
...
<cfif GetListAvailReports.RecordCount GT 0>
  ...
  </div>   <p class="text-center"><a href="Sitemap.cfm">Site Map</a></p>
...
<script type="text/javascript">
  ...
  function loadInfo() { 
    self.location.href ="/state-accounting/sams/sams-monthly-reports/index.cfm?ReportNo=&FY=&Accounting_Period=&Agency_No=&loadInfo=";
      return true;
  ...
  function SetReport() { 
    if (document.GetSelectionInfo.ReportNo.value == 'SB05') {
      self.location.href ="/state-accounting/sams/sams-monthly-reports/index.cfm?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY=&Accounting_Period=&Agency_No=&loadInfo=&AgencyTitle=FundNo";
      return true;
    }
    else {
      self.location.href ="/state-accounting/sams/sams-monthly-reports/index.cfm?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY=&Accounting_Period=&Agency_No=&loadInfo=&AgencyTitle=AgencyNo";
      return true;
    }
  ...
  function SetFY() { 
    if (document.GetSelectionInfo.ReportNo.value == 'SB05') {
      self.location.href ="/state-accounting/sams/sams-monthly-reports/index.cfm?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY="+document.GetSelectionInfo.FY.value+"&Accounting_Period=&Agency_No=&loadInfo=&AgencyTitle=FundNo";
      return true;
    }
    else {
      self.location.href ="/state-accounting/sams/sams-monthly-reports/index.cfm?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY="+document.GetSelectionInfo.FY.value+"&Accounting_Period=&Agency_No=&loadInfo=&AgencyTitle=AgencyNo";
      return true;
    }
  ...
  function SetAccountingPeriod() { 
    if (document.GetSelectionInfo.ReportNo.value == 'SB05') {
      self.location.href ="/state-accounting/sams/sams-monthly-reports/index.cfm?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY="+document.GetSelectionInfo.FY.value+"&Accounting_Period="+document.GetSelectionInfo.Accounting_Period.value+"&Agency_No=&loadInfo=&AgencyTitle=FundNo";
      return true;
    }
    else {
      self.location.href ="/state-accounting/sams/sams-monthly-reports/index.cfm?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY="+document.GetSelectionInfo.FY.value+"&Accounting_Period="+document.GetSelectionInfo.Accounting_Period.value+"&Agency_No=&loadInfo=&AgencyTitle=AgencyNo";
      return true;
    }
  ...
  function SetAgency() { 
    if (document.GetSelectionInfo.ReportNo.value == 'SB05') {
      self.location.href ="/state-accounting/sams/sams-monthly-reports/index.cfm?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY="+document.GetSelectionInfo.FY.value+"&Accounting_Period="+document.GetSelectionInfo.Accounting_Period.value+"&Agency_No="+document.GetSelectionInfo.Agency_No.value+"&loadInfo=Yes&AgencyTitle=FundNo";
      return true;
    }
    else {
      self.location.href ="/state-accounting/sams/sams-monthly-reports/index.cfm?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY="+document.GetSelectionInfo.FY.value+"&Accounting_Period="+document.GetSelectionInfo.Accounting_Period.value+"&Agency_No="+document.GetSelectionInfo.Agency_No.value+"&loadInfo=Yes&AgencyTitle=AgencyNo";
      return true;
    }
