      ...
      <cfloop list="#arguments.fields#" index="arguments.field">
        ...
        <cfswitch expression="#arguments.field#">
            ...
            <cfelseif listFind("Search,Feed,Related",arguments.type) and arguments.item.getValue('parentType') eq 'Calendar' and isDate(arguments.item.getValue('displayStart'))>
              <#variables.$.getContentListPropertyValue(arguments.field,'tag')# class="releaseDate">
                ...
                <cfif LSDateFormat(arguments.item.getValue('displayStart'),"short") lt LSDateFormat(arguments.item.getValue('displayStop'),"short")>
                  #LSDateFormat(arguments.item.getValue('displayStart'),variables.$.getShortDateFormat())# - #LSDateFormat(arguments.item.getValue('displayStop'),variables.$.getShortDateFormat())#
                <cfelse>
                  #LSDateFormat(arguments.item.getValue('displayStart'),variables.$.getLongDateFormat())#
                </cfif>
              #variables.$.getContentListPropertyValue(arguments.field,"closingInnerMarkUp")#
              </#variables.$.getContentListPropertyValue(arguments.field,'tag')#>
          ...
          <cfcase value="Title">
            ...
            <cfif arguments.type eq "Search">
              <a href="/#arguments.item.getValue('filename')#">http://#$.siteConfig('domain')#/#arguments.item.getValue('filename')#</a>
            </cfif>
          </cfcase>
          <cfcase value="Image">
            <cfif arguments.hasImage>
              ...
              <img src="#arguments.item.getImageURL()#"  alt="#htmlEditFormat(arguments.item.getValue('title'))#"/>
              <cfelse>

              <a href="#arguments.item.getURL()#" title="#HTMLEditFormat(arguments.item.getValue('title'))#" class="#this.contentListItemImageLinkClass#"><img src="#arguments.item.getImageURL(size='#arguments.imageSize#')#"  alt="#htmlEditFormat(arguments.item.getValue('title'))#"/></a>
              </cfif>
            #variables.$.getContentListPropertyValue(arguments.field,"closingInnerMarkUp")#
            </#variables.$.getContentListPropertyValue(arguments.field,'tag')#>
            </cfif>
