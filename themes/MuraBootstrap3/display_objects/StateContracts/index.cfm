...
<cfelseif IsDefined ("URL.Issue_Year")>
  ...
  <cfinvoke
    component = "model.beans.StateContract_SQL"
...
<CFIF isDefined("form.contractFY")>
 ...
 <!--- Get Friendly Names --->
   <cfinvoke component="model.beans.StateContract_SQL"
...
<!--- Get Fiscal years --->
 <cfinvoke component="model.beans.StateContract_SQL"
  ...
  <cfinvokeargument name="MaxFY" value="2018">
        ...
        <div class="col-sm-10 col-sm-offset-1">
          ...
          #$.getSummary()#
           <div class="example alert alert-danger hidden" id="errorMsg"> Please Enter Search Criteria.</div>
            ...
            <form method="post" enctype="application/x-www-form-urlencoded" name="DisplayValue" preloader="no" id="searchform">

              <div class="row">
                    <div class="col-xs-12 col-sm-5 col-sm-offset-0 col-md-5 col-md-offset-1 label-div">
                        <div class="btn-label">Search by Vendor Name / Contract Number</div>
                    </div>
              ...
              <div class="row">
                ...
                <div class="text-center">
                    <input type="submit" id="btnSearch" name="submitted" class="btn btn-success" value="Search">
                </div>
            </form>
      ...
      <div class="row">
        <div class="col-sm-10 col-sm-offset-1">
           ...
           <div class="alert alert-info small">
             <span class="small"> <img src="/ledger/includes/themes/TheLedger/images/infoIcon.png" style="height:30px">&nbsp;Your search returned #NumberFormat(GetContractInfo.recordcount,",")# records. The download and sort options are not available for results greater than 5,000 records. Please narrow your search if you wish to use these features.</span></div>
              <!--- <cftry>
    ...
    <!--- <p class="RecordCountLabel">Records found: <B>#NUMBERFORMAT(GetContractInfo.recordcount)#</B> Total Pages: <B>#NUMBERFORMAT(TotalPages)#</B></p> --->
      <div class="result">
        <div class="table-responsive">
          ...
          <cfelse>
            ...
            <thead>
              <tr>
                <th class="bg-info"><br><br><a href="?PageIndex=1&contractFY=#variables.FY#&contractAgency=#URLEncodedFormat(variables.AgencyName)#&contractClass=#URLEncodedFormat(variables.contractClass)#&contractType=#URLEncodedFormat(variables.TypeDescription)#&contractAward=#URLEncodedFormat(variables.AwardDescription)#&FindVendor=#URLEncodedFormat(variables.FindVendor)#&ContractVendor=#URLEncodedFormat(variables.ContractVendor)#&SortColumn=6&SortDirection=#variables.SortDirection#&header=true">Vendor</a><br></th>
                <th class="bg-info"><br><br><a href="?PageIndex=1&contractFY=#variables.FY#&contractAgency=#URLEncodedFormat(variables.AgencyName)#&contractClass=#URLEncodedFormat(variables.contractClass)#&contractType=#URLEncodedFormat(variables.TypeDescription)#&contractAward=#URLEncodedFormat(variables.AwardDescription)#&FindVendor=#URLEncodedFormat(variables.FindVendor)#&ContractVendor=#URLEncodedFormat(variables.ContractVendor)#&SortColumn=1&SortDirection=#variables.SortDirection#&header=true">Agency</a><br></th>
                <th class="bg-info"><br><a href="?PageIndex=1&contractFY=#variables.FY#&contractAgency=#URLEncodedFormat(variables.AgencyName)#&contractClass=#URLEncodedFormat(variables.contractClass)#&contractType=#URLEncodedFormat(variables.TypeDescription)#&contractAward=#URLEncodedFormat(variables.AwardDescription)#&FindVendor=#URLEncodedFormat(variables.FindVendor)#&ContractVendor=#URLEncodedFormat(variables.ContractVendor)#&SortColumn=2&SortDirection=#variables.SortDirection#&header=true">Contract Number</a><br></th>
                <th class="sum bg-info text-center"><a href="?PageIndex=1&contractFY=#variables.FY#&contractAgency=#URLEncodedFormat(variables.AgencyName)#&contractClass=#URLEncodedFormat(variables.contractClass)#&contractType=#URLEncodedFormat(variables.TypeDescription)#&contractAward=#URLEncodedFormat(variables.AwardDescription)#&FindVendor=#URLEncodedFormat(variables.FindVendor)#&ContractVendor=#URLEncodedFormat(variables.ContractVendor)#&SortColumn=10&SortDirection=#variables.SortDirection#&header=true">Current Contract Amount</a><br></th>

                <th class="bg-info text-center"><a href="?PageIndex=1&amp;contractFY=#variables.FY#&amp;contractAgency=#URLEncodedFormat(variables.AgencyName)#&amp;contractClass=#URLEncodedFormat(variables.contractClass)#&amp;contractType=#URLEncodedFormat(variables.TypeDescription)#&amp;contractAward=#URLEncodedFormat(variables.AwardDescription)#&amp;FindVendor=#URLEncodedFormat(variables.FindVendor)#&amp;ContractVendor=#URLEncodedFormat(variables.ContractVendor)#&amp;SortColumn=13&amp;SortDirection=#variables.SortDirection#&amp;header=true">Contract Transparency Document</a><br></th>
                <th class="bg-info text-center no-sort">Details<br></th>                
                <th class="bg-info no-sort">Payments<br></th>
              </tr>
            </thead>
     ...
     <CFIF CurrentRow GTE StartRow>
                  ...
                  <tr>
                    ...
                    <td class="text-center"><CFIF TRIM(getContractInfo.CTD_Document) IS NOT ""><a title="Contract Transparency Document" href="/CTDDocs/#getContractInfo.CTD_Document#" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <img src="/ledger/includes/themes/TheLedger/images/CTDicon.png">    
                   </a><cfelse>NA</CFIF></td>
                    <td>
                      <a style="text-decoration: underline;" href="#$.content().getURL()#?mcaction=contractDetails&ID=#Contract_Number#&ID2=#GetContractInfo.Fiscal_Year#&ID3=#GetContractInfo.Agency#&ID4=#getContractInfo.CTD_Document#&contractAgency=#URLEncodedFormat(variables.AgencyName)#&contractAward=#URLEncodedFormat(variables.AwardDescription)#&contractType=#URLEncodedFormat(variables.TypeDescription)#&contractClass=#URLEncodedFormat(variables.contractClass)#&FindVendor=#URLEncodedFormat(variables.FindVendor)#&contractFY=#GetContractInfo.Fiscal_Year#&varClassCode=#GetContractInfo.Class_Code#&VName=#trim(GetContractInfo.Name)#">Contract Details</a>
                     </td>                    
                    <td> <a style="text-decoration: underline;" href="#$.content().getURL()#?mcaction=paymentDetails&ID=#Contract_Number#&ID2=#GetContractInfo.Fiscal_Year#&ID3=#GetContractInfo.Agency#&ID4=#getContractInfo.CTD_Document#&contractAgency=#URLEncodedFormat(variables.AgencyName)#&contractAward=#URLEncodedFormat(variables.AwardDescription)#&contractType=#URLEncodedFormat(variables.TypeDescription)#&contractClass=#URLEncodedFormat(variables.contractClass)#&FindVendor=#URLEncodedFormat(variables.FindVendor)#&contractFY=#GetContractInfo.Fiscal_Year#&varClassCode=#GetContractInfo.Class_Code#&VName=#trim(GetContractInfo.Name)#">Payments</a></td>
                 ...
                 <!--- Display First Page link only if the page number being viewed is greater than 1 and there is more than 3 pages of records --->
                    ...
                    <cfloop index="Pages" from="0" to="#TotalPages#">
                        ...
                        <CFIF DisplayPgNo GTE (URL.PageIndex - 3) AND DisplayPgNo LTE (URL.PageIndex + 3)>
                               ...
                               <li><a href="?PageIndex=#pages#&contractFY=#variables.FY#&contractAgency=#URLEncodedFormat(variables.AgencyName)#&contractClass=#URLEncodedFormat(variables.contractClass)#&contractType=#URLEncodedFormat(variables.TypeDescription)#&contractAward=#URLEncodedFormat(variables.AwardDescription)#&FindVendor=#URLEncodedFormat(variables.FindVendor)#&ContractVendor=#URLEncodedFormat(variables.ContractVendor)#&SortColumn=#variables.SortColumn#&SortDirection=#variables.SortDirection#"><strong>#DisplayPgNo#</strong></a></li>
                            <cfelse>
                          ...
                          <cfelseif MiddlePageNumberNextSwitch IS false AND DisplayPgNo GT (URL.PageIndex - 4) AND URL.PageIndex LT TotalPages>
                            <!--- Goto Next Page only --->
                             <li><a href="?PageIndex=#pages+1#&contractFY=#variables.FY#&contractAgency=#URLEncodedFormat(variables.AgencyName)#&contractClass=#URLEncodedFormat(variables.contractClass)#&contractType=#URLEncodedFormat(variables.TypeDescription)#&contractAward=#URLEncodedFormat(variables.AwardDescription)#&FindVendor=#URLEncodedFormat(variables.FindVendor)#&ContractVendor=#URLEncodedFormat(variables.ContractVendor)#&SortColumn=#variables.SortColumn#&SortDirection=#variables.SortDirection#">Next</a></li>
                    ...
                    <CFIF URL.PageIndex IS NOT TotalPages AND TotalPages GTE 3>
                         <li><a href="?PageIndex=#TotalPages#&contractFY=#variables.FY#&contractAgency=#URLEncodedFormat(variables.AgencyName)#&contractClass=#URLEncodedFormat(variables.contractClass)#&contractType=#URLEncodedFormat(variables.TypeDescription)#&contractAward=#URLEncodedFormat(variables.AwardDescription)#&FindVendor=#URLEncodedFormat(variables.FindVendor)#&ContractVendor=#URLEncodedFormat(variables.ContractVendor)#&SortColumn=#variables.SortColumn#&SortDirection=#variables.SortDirection#">Last >> [#TotalPages#]</a></li>
                    </CFIF>
                    </ul>
                </div>
               </cfif>
          ...
          <CFIF (IsDefined ("Error") AND Error IS 1) OR (GetContractInfo.recordcount EQ 0)>
                <!--- Display Query Input error  --->
                    <div class="col-md-12" align="center">
                        <BR /><h4>No records found. Please use different search criteria.</h4>
                    </div>
               </CFIF>
</cfif>
      ...
      <div class="col-sm-12 text-center">
         <cftry>
          <div class="text-center" style="padding-bottom: 15px;">
           <a href="http://ledger.illinoiscomptroller.gov/downloads/#exportfile#" class="btn btn-success" role="button" style="margin-bottom:10px;">Click here to Download Current Fiscal Year Contracts</a>
           </div>
