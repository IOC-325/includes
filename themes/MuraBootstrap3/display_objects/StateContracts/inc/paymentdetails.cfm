...
<cfoutput>
	<table width="80%" align="center">
		<tr>
			...
			<td style="padding:0px 50px 0px 20px" align="right"><a href="#$.content().getURL()#?mcaction=contractDetails&ID=#URL.ID#&ID2=#URL.ID2#&ID3=#URL.ID3#&ID4=#URL.ID4#&varClassCode=#URL.varClassCode#&VNAME=#URL.VName#">Show Contract Detail</a></td>
			...
			<cfelse>
				<a href="#$.content().getURL()#?ID=#URL.ID#&ID2=#URL.ID2#&ID3=#URL.ID3#&ID4=#URL.ID4#">Return to State Contracts</a>
			</cfif>
			</td>
		</tr>
		<tr>
					<td><cfif ArrayLen(Results) GT 0>Agency: <B>#Results[1].AGENCY_NAME#</B></cfif></h3> </td>
		</tr>
        <tr>
					<td><cfif ArrayLen(Results) GT 0>Vendor: <B>#Results[1].VENDOR_NAME#</B></cfif></h3> </td>
		</tr>        
	</table>
