<cfscript>
  ...
  // if ( !ListFind('list,edit,editphone,delete,sitemap', LCase(m.event('mcaction'))) ) {
  //   m.event('mcaction', 'list');
  //   //WriteDump("#m.event('mcaction')#");
  // }

  // SiteMap
     // if ( m.event('mcaction') == 'sitemap' ) {
     //    // WriteDump("#m.event('mcaction')#");
     //     //m.event('mcaction', 'sitemap');
     //      message = {
     //      type = 'success'
     //      , text = '<i class="fa fa-thumbs-o-up"></i> Site Map.'
     //    };
     //   } 
      ...
      <!--- Body --->
        <div class="muracontacts-body">
          <!--- <cftry> --->
            ...
            <p class="bold-subHeader text-center">Monthly Reports</p>

<p class="text-center">Select the Report, FY, Month and Agency No/Fund No to get a list of the available pdf files. For additional instructions click <a href="http://illinoiscomptroller.gov/ioc-pdf/SAMSMonthlyRpt/Instructions.pdf">here</a>.</p>

<p>&nbsp;</p>

<form action="" id="samsMonthlyReports" method="post" name="GetSelectionInfo">
	<div class="row">
		<div class="col-md-3 col-md-offset-2 label-div">
			<div class="btn-label">Report Name</div>
		</div>

		<div class="col-md-5">
      <select id="ReportNo" name="ReportNo" onchange="SetReport();">
        <option value="" selected>Report Name</option>
         <cfloop query="GetListReports">
          <option <cfif variables.ReportNo EQ ListToArray(ReportNo,"-")[1].trim()> selected </cfif> value="#ListToArray(ReportNo,"-")[1]#">#GetListReports.ReportNo#</option>
         </cfloop>
      </select>
    </div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-5">
      <select class="select2" id="FY" name="FY" onchange="SetFY();">
        <option value="" selected>Fiscal Year</option>
         <cfloop query="getListFY">
          <option <cfif variables.FY EQ getListFY.FY.trim()> selected </cfif> value="#getListFY.FY#">#getListFY.FY#</option>
         </cfloop>
      </select>
    </div>
	</div>
      ...
      <select class="select2" id="Accounting_Period" name="Accounting_Period" onchange="SetAccountingPeriod();">
        <option value="" selected>Month</option>
         <cfloop query="getListMonths">
          <option <cfif variables.Accounting_Period EQ getListMonths.Accounting_Period.trim() AND variables.Accounting_Period NEQ ""> selected </cfif> value="#getListMonths.Accounting_Period#">#getListMonths.Accounting_Period#</option>
         </cfloop>        
      </select>
    </div>
	</div>
	...
	<div class="row">
		<div class="col-md-3 col-md-offset-2 label-div">
			<div class="btn-label">Agency Number</div>
		</div>

		<div class="col-md-5">
      <select class="select2" id="Agency_No" name="Agency_No" onchange="SetAgency();" >
        <option value="">Agency Number</option>
         <cfloop query="getListAgencies">
          <option <cfif variables.Agency_No EQ ListToArray(Agency_No,"-")[1].trim() AND variables.Agency_No NEQ ""> selected </cfif> value="#ListToArray(Agency_No,"-")[1].trim()#">#getListAgencies.Agency_No#</option>
         </cfloop>          
      </select>
    </div>
...
<cfif GetListAvailReports.RecordCount GT 0>
      ...
      <div class="row col-md-8 col-md-offset-2 text-center" style="padding-top: 10px;"> 
...
<script type="text/javascript">
  ...
  function loadInfo() { 
    self.location.href ="/agencies/sams/sams-monthly-reports/?ReportNo=&FY=&Accounting_Period=&Agency_No=&loadInfo=";
      return true;
  ...
  function SetReport() { 
    if (document.GetSelectionInfo.ReportNo.value == 'SB05') {
      self.location.href ="/agencies/sams/sams-monthly-reports/?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY=&Accounting_Period=&Agency_No=&loadInfo=&AgencyTitle=FundNo";
      return true;
    }
    else {
      console.log("/agencies/sams/sams-monthly-reports/?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY=&Accounting_Period=&Agency_No=&loadInfo=&AgencyTitle=AgencyNo");
      self.location.href ="/agencies/sams/sams-monthly-reports/?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY=&Accounting_Period=&Agency_No=&loadInfo=&AgencyTitle=AgencyNo";
      return true;
    }
  ...
  function SetFY() { 
    if (document.GetSelectionInfo.ReportNo.value == 'SB05') {
      self.location.href ="/agencies/sams/sams-monthly-reports/?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY="+document.GetSelectionInfo.FY.value+"&Accounting_Period=&Agency_No=&loadInfo=&AgencyTitle=FundNo";
      return true;
    }
    else {
      self.location.href ="/agencies/sams/sams-monthly-reports/?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY="+document.GetSelectionInfo.FY.value+"&Accounting_Period=&Agency_No=&loadInfo=&AgencyTitle=AgencyNo";
      return true;
    }
  ...
  function SetAccountingPeriod() { 
    if (document.GetSelectionInfo.ReportNo.value == 'SB05') {
      self.location.href ="/agencies/sams/sams-monthly-reports/?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY="+document.GetSelectionInfo.FY.value+"&Accounting_Period="+document.GetSelectionInfo.Accounting_Period.value+"&Agency_No=&loadInfo=&AgencyTitle=FundNo";
      return true;
    }
    else {
      self.location.href ="/agencies/sams/sams-monthly-reports/?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY="+document.GetSelectionInfo.FY.value+"&Accounting_Period="+document.GetSelectionInfo.Accounting_Period.value+"&Agency_No=&loadInfo=&AgencyTitle=AgencyNo";
      return true;
    }
  ...
  function SetAgency() { 
    if (document.GetSelectionInfo.ReportNo.value == 'SB05') {
      self.location.href ="/agencies/sams/sams-monthly-reports/?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY="+document.GetSelectionInfo.FY.value+"&Accounting_Period="+document.GetSelectionInfo.Accounting_Period.value+"&Agency_No="+document.GetSelectionInfo.Agency_No.value+"&loadInfo=Yes&AgencyTitle=FundNo";
      return true;
    }
    else {
      self.location.href ="/agencies/sams/sams-monthly-reports/?ReportNo="+document.GetSelectionInfo.ReportNo.value+"&FY="+document.GetSelectionInfo.FY.value+"&Accounting_Period="+document.GetSelectionInfo.Accounting_Period.value+"&Agency_No="+document.GetSelectionInfo.Agency_No.value+"&loadInfo=Yes&AgencyTitle=AgencyNo";
      return true;
    }
