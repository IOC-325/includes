...
<form id="#variables.frmID#" class="#variables.$.siteConfig('bsFormLayout')# mura-form-builder" method="post"<cfif isMultipart>enctype="multipart/form-data"</cfif>>
	...
	<div class="#this.formBuilderButtonWrapperClass#">
		<br>
		<input type="submit" class="#this.formBuilderSubmitClass#" value="#$.rbKey('form.submit')#">
		<p><a href="#$.createHref(filename='policies/privacy-policy')#" class="privacy-link">Privacy Policy</a></p>
	</div>
